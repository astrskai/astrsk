import{r as he,j as e}from"./iframe-BUpCnHpM.js";import{c as Ct,f as qt}from"./utils-CF6QUdYH.js";import{u as Ht,B as kt,C as Yt,a as Jt,b as xe,c as Vt,d as At,e as te,S as se,f as vt,D as wt,T as jt,L as i,g as $t}from"./useImageRenderer-C1ak6q0g.js";import{S as s}from"./Skeleton-BRDni_gk.js";import{L as p}from"./lock-B-6Rzcum.js";import{U as Lt}from"./user-lDCMrtDU.js";import{c as oe}from"./createLucideIcon-BzvUAZnp.js";import{M as Kt}from"./message-square-BDiKzcmH.js";import"./preload-helper-CwRszBsw.js";/**
 * @license lucide-react v0.503.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ot=[["path",{d:"M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z",key:"c3ymky"}]],Zt=oe("heart",Ot);/**
 * @license lucide-react v0.503.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Qt=[["polygon",{points:"6 3 20 12 6 21 6 3",key:"1oa8hb"}]],l=oe("play",Qt);/**
 * @license lucide-react v0.503.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Xt=[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"M12 5v14",key:"s699le"}]],c=oe("plus",Xt),zt=At,re=te;function r({name:t,imageUrl:X,summary:ne,tags:g,maxVisibleTags:h=3,tokenCount:Et=0,updatedAt:ie,className:Nt,actions:Dt=[],isDisabled:Mt=!1,onClick:Pt,badges:x=[],placeholderImageUrl:ee,renderMetadata:le,emptySummaryText:ce="No summary",likeButton:ae,likeCount:de,downloadCount:me,imageSizes:Tt,loading:Ut="lazy",footerActions:ue,renderImage:Rt}){const[It,pe]=he.useState(!1),Bt=Ht({renderImage:Rt});he.useEffect(()=>{pe(!1)},[X,ee]);const ge=(X||ee)&&!It,Wt=!ge,_t=()=>{const o=X||ee;return o?Bt({src:o,alt:t,className:"absolute inset-0 h-full w-full object-cover transition-transform duration-500 group-hover:scale-105",sizes:Tt,loading:Ut,onError:()=>pe(!0),fill:!0}):null};return e.jsxs(kt,{className:Ct("min-h-[380px]",Nt),isDisabled:Mt,onClick:Pt,children:[e.jsxs("div",{className:"relative h-64 overflow-hidden bg-zinc-800",children:[ge&&_t(),Wt&&e.jsx("div",{className:"absolute inset-0 flex items-center justify-center",children:e.jsx("span",{className:"text-6xl font-bold text-zinc-500",children:t.charAt(0).toUpperCase()||"?"})}),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-zinc-900 via-zinc-900/40 to-transparent"}),ae&&e.jsx("div",{className:"absolute top-2 right-2 z-20",children:e.jsx(Yt,{...ae})}),e.jsx(Jt,{actions:Dt,className:ae?"top-12":void 0}),x.some(o=>(o.position??"left")==="left")&&e.jsx("div",{className:"absolute top-3 left-3 z-10 max-w-[45%]",children:e.jsx(xe,{badges:x,position:"left"})}),x.some(o=>o.position==="right")&&e.jsx("div",{className:"absolute top-3 right-3 z-10 max-w-[45%]",children:e.jsx(xe,{badges:x,position:"right"})})]}),e.jsxs("div",{className:"relative z-10 -mt-12 flex flex-grow flex-col p-4",children:[e.jsx("h3",{className:"mb-1 line-clamp-2 text-lg md:text-xl font-bold break-words text-white drop-shadow-md",children:t}),e.jsx("div",{className:"mb-2 md:mb-4 flex flex-wrap gap-2",children:g.length>0?e.jsxs(e.Fragment,{children:[g.slice(0,h).map((o,Ft)=>{const Gt=Math.floor(85/(h+1));return e.jsx("span",{className:"truncate rounded border border-zinc-700/50 bg-zinc-800/80 px-1.5 py-0.5 text-[10px] text-zinc-300",style:{maxWidth:`${Gt}%`},children:o},`${o}-${Ft}`)}),g.length>h&&e.jsxs("span",{className:"shrink-0 rounded border border-zinc-700/50 bg-zinc-800/80 px-1.5 py-0.5 text-[10px] text-zinc-300",children:["+",g.length-h]})]}):e.jsx("span",{className:"text-[10px] text-zinc-400",children:"No tags"})}),(ne||ce)&&e.jsx("p",{className:"mb-2 md:mb-4 line-clamp-2 flex-grow text-xs leading-relaxed break-all text-ellipsis text-zinc-400",children:ne||ce}),(de!==void 0||me!==void 0)&&e.jsx(Vt,{likeCount:de,downloadCount:me,className:"mb-2"}),le?le():e.jsxs(At,{children:[e.jsxs(te,{children:[qt(Et)," Tokens"]}),ie&&e.jsx(te,{children:ie})]})]}),ue&&e.jsx("div",{className:"mt-auto flex border-t border-zinc-800",children:ue})]})}r.__docgenInfo={description:"",methods:[],displayName:"CharacterCard",props:{name:{required:!0,tsType:{name:"string"},description:"Character name"},imageUrl:{required:!1,tsType:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}]},description:"Character image URL"},summary:{required:!1,tsType:{name:"string"},description:"Character summary/description"},tags:{required:!0,tsType:{name:"Array",elements:[{name:"string"}],raw:"string[]"},description:"Character tags"},maxVisibleTags:{required:!1,tsType:{name:"number"},description:`Maximum number of tags to display before showing "+n" indicator.
...
}`,...(be=(fe=a.parameters)==null?void 0:fe.docs)==null?void 0:be.source}}};var Ce,ke,Ae;y.parameters={...y.parameters,docs:{...(Ce=y.parameters)==null?void 0:Ce.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    badges: [{
      label: 'CHARACTER',
...
}`,...(Ae=(ke=y.parameters)==null?void 0:ke.docs)==null?void 0:Ae.source}}};var ve,we,je;f.parameters={...f.parameters,docs:{...(ve=f.parameters)==null?void 0:ve.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    badges: [{
      label: 'CHARACTER',
...
}`,...(je=(we=f.parameters)==null?void 0:we.docs)==null?void 0:je.source}}};var Le,ze,Se;b.parameters={...b.parameters,docs:{...(Le=b.parameters)==null?void 0:Le.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    badges: [{
      label: 'CHARACTER',
...
}`,...(De=(Ne=C.parameters)==null?void 0:Ne.docs)==null?void 0:De.source}}};var Me,Pe,Te;k.parameters={...k.parameters,docs:{...(Me=k.parameters)==null?void 0:Me.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    badges: [{
      label: 'CHARACTER',
...
}`,...(Te=(Pe=k.parameters)==null?void 0:Pe.docs)==null?void 0:Te.source}}};var Ue,Re,Ie;A.parameters={...A.parameters,docs:{...(Ue=A.parameters)==null?void 0:Ue.docs,source:{originalSource:`{
  args: {
...
}`,...(Ie=(Re=A.parameters)==null?void 0:Re.docs)==null?void 0:Ie.source}}};var Be,We,_e;v.parameters={...v.parameters,docs:{...(Be=v.parameters)==null?void 0:Be.docs,source:{originalSource:`{
  args: {
...
}`,...(_e=(We=v.parameters)==null?void 0:We.docs)==null?void 0:_e.source}}};var Fe,Ge,qe;w.parameters={...w.parameters,docs:{...(Fe=w.parameters)==null?void 0:Fe.docs,source:{originalSource:`{
  args: {
    name: 'Alice Wonderland',
...
}`,...(da=(ca=D.parameters)==null?void 0:ca.docs)==null?void 0:da.source}}};var ma,ua,pa;M.parameters={...M.parameters,docs:{...(ma=M.parameters)==null?void 0:ma.docs,source:{originalSource:`{
  args: {
...
}`,...(pa=(ua=M.parameters)==null?void 0:ua.docs)==null?void 0:pa.source}}};var ga,ha,xa;P.parameters={...P.parameters,docs:{...(ga=P.parameters)==null?void 0:ga.docs,source:{originalSource:`{
  args: {
...
}`,...(xa=(ha=P.parameters)==null?void 0:ha.docs)==null?void 0:xa.source}}};var ya,fa,ba;T.parameters={...T.parameters,docs:{...(ya=T.parameters)==null?void 0:ya.docs,source:{originalSource:`{
  args: {
    ...Default.args
  },
  decorators: [Story => <div style={{
...
}`,...(ba=(fa=T.parameters)==null?void 0:fa.docs)==null?void 0:ba.source}}};var Ca,ka,Aa;U.parameters={...U.parameters,docs:{...(Ca=U.parameters)==null?void 0:Ca.docs,source:{originalSource:`{
  args: {
    ...Default.args
  },
  decorators: [Story => <div style={{
...
}`,...(Sa=(za=I.parameters)==null?void 0:za.docs)==null?void 0:Sa.source}}};var Ea,Na,Da;B.parameters={...B.parameters,docs:{...(Ea=B.parameters)==null?void 0:Ea.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    likeButton: {
      isLiked: true,
...
}`,...(Da=(Na=B.parameters)==null?void 0:Na.docs)==null?void 0:Da.source}}};var Ma,Pa,Ta;W.parameters={...W.parameters,docs:{...(Ma=W.parameters)==null?void 0:Ma.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    likeCount: 1234
  }
}`,...(Ta=(Pa=W.parameters)==null?void 0:Pa.docs)==null?void 0:Ta.source}}};var Ua,Ra,Ia;_.parameters={..._.parameters,docs:{...(Ua=_.parameters)==null?void 0:Ua.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    downloadCount: 5678
  }
}`,...(Ia=(Ra=_.parameters)==null?void 0:Ra.docs)==null?void 0:Ia.source}}};var Ba,Wa,_a;F.parameters={...F.parameters,docs:{...(Ba=F.parameters)==null?void 0:Ba.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    likeCount: 1234,
    downloadCount: 5678
  }
}`,...(_a=(Wa=F.parameters)==null?void 0:Wa.docs)==null?void 0:_a.source}}};var Fa,Ga,qa;G.parameters={...G.parameters,docs:{...(Fa=G.parameters)==null?void 0:Fa.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    likeButton: {
      isLiked: false,
...
}`,...(dt=(ct=K.parameters)==null?void 0:ct.docs)==null?void 0:dt.source}}};var mt,ut,pt;O.parameters={...O.parameters,docs:{...(mt=O.parameters)==null?void 0:mt.docs,source:{originalSource:`{
  args: {
...
}`,...(pt=(ut=O.parameters)==null?void 0:ut.docs)==null?void 0:pt.source}}};var gt,ht,xt;Z.parameters={...Z.parameters,docs:{...(gt=Z.parameters)==null?void 0:gt.docs,source:{originalSource:`{
  args: {
    ...Default.args
  },
  decorators: [Story => <div style={{
...
}`,...(xt=(ht=Z.parameters)==null?void 0:ht.docs)==null?void 0:xt.source}}};var yt,ft,bt;Q.parameters={...Q.parameters,docs:{...(yt=Q.parameters)==null?void 0:yt.docs,source:{originalSource:`{
  args: {
    ...Default.args
  },
  decorators: [Story => <div style={{
...
}`,...(bt=(ft=Q.parameters)==null?void 0:ft.docs)==null?void 0:bt.source}}};const dr=["Default","WithBadges","WithMultipleBadges","WithAllBadgeVariants","WithBadgesLeftAndRight","WithMultipleBadgesEachSide","WithoutImage","WithPlaceholder","ImageError","ManyTags","NoTags","LongName","Disabled","WithActions","GridLayout","CustomMetadata","MetadataWithIcons","FullyCustomMetadata","AllStates","Skeleton","SkeletonGrid","WithLikeButton","WithLikeButtonLiked","WithLikeCount","WithDownloadCount","WithPopularityStats","WithLikeButtonAndStats","WithLikeButtonLikedAndStats","WithLikeButtonAndActions","HighPopularityCounts","FullFeatured","WithFooterActions","WithFooterActionsSelectedPlayer","WithFooterActionsSelectedAI","WithFooterActionsCompact","GridLayoutWithFooterActions","GridLayoutWithPopularity"];export{T as AllStates,D as CustomMetadata,a as Default,S as Disabled,J as FullFeatured,P as FullyCustomMetadata,N as GridLayout,Z as GridLayoutWithFooterActions,Q as GridLayoutWithPopularity,Y as HighPopularityCounts,w as ImageError,z as LongName,j as ManyTags,M as MetadataWithIcons,L as NoTags,U as Skeleton,R as SkeletonGrid,E as WithActions,b as WithAllBadgeVariants,y as WithBadges,C as WithBadgesLeftAndRight,_ as WithDownloadCount,V as WithFooterActions,O as WithFooterActionsCompact,K as WithFooterActionsSelectedAI,$ as WithFooterActionsSelectedPlayer,I as WithLikeButton,H as WithLikeButtonAndActions,G as WithLikeButtonAndStats,B as WithLikeButtonLiked,q as WithLikeButtonLikedAndStats,W as WithLikeCount,f as WithMultipleBadges,k as WithMultipleBadgesEachSide,v as WithPlaceholder,F as WithPopularityStats,A as WithoutImage,dr as __namedExportsOrder,cr as default};
