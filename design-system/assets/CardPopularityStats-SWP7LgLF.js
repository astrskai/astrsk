import{c as i}from"./createLucideIcon-ndCdlt97.js";import{j as a}from"./iframe-CWPN1G4B.js";import{c as s}from"./utils-DuMXYCiK.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const h=[["path",{d:"M12 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7",key:"1m0v6g"}],["path",{d:"M18.375 2.625a1 1 0 0 1 3 3l-9.013 9.014a2 2 0 0 1-.853.505l-2.873.84a.5.5 0 0 1-.62-.62l.84-2.873a2 2 0 0 1 .506-.852z",key:"ohrbg2"}]],z=i("square-pen",h);/**
 * @license lucide-react v0.503.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const f=[["path",{d:"M3 6h18",key:"d0wm0j"}],["path",{d:"M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6",key:"4alrt4"}],["path",{d:"M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2",key:"v07s0e"}],["line",{x1:"10",x2:"10",y1:"11",y2:"17",key:"1uufr5"}],["line",{x1:"14",x2:"14",y1:"11",y2:"17",key:"xtxkd"}]],L=i("trash-2",f);function x({children:e,className:r,isDisabled:o=!1,onClick:t}){return a.jsx("article",{className:s("group relative flex h-full flex-col overflow-hidden","rounded-xl border border-zinc-800 bg-zinc-900 shadow-lg","transition-all duration-300",!o&&t&&"cursor-pointer hover:border-zinc-600 hover:shadow-xl",o&&"pointer-events-none opacity-60",r),onClick:o?void 0:t,children:e})}x.__docgenInfo={description:`BaseCard Component (Internal)
...
\`\`\``,methods:[],displayName:"CardMetadataItem",props:{icon:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""}}};const v={default:"border-white/10 bg-black/50 text-white",private:"border-amber-500/30 bg-amber-950/50 text-amber-300",owner:"border-blue-500/30 bg-blue-950/50 text-blue-300"};function b({badges:e,position:r,className:o}){const t=r?e.filter(n=>(n.position??"left")===r):e;return t.length===0?null:a.jsx("div",{className:s("flex flex-wrap gap-1.5",r==="right"&&"justify-end",o),children:t.map((n,d)=>a.jsxs("div",{className:s("flex max-w-full items-center gap-1 rounded border px-2 py-1 text-[10px] font-bold backdrop-blur-md",v[n.variant??"default"]),children:[a.jsx("span",{className:"shrink-0",children:n.icon}),a.jsx("span",{className:"truncate",children:n.label})]},`${n.label}-${d}`))})}b.__docgenInfo={description:`CardBadges Component
