import{r as i,e as le,j as e}from"./iframe-D8itxpWD.js";import{c as C}from"./utils-DuMXYCiK.js";import{C as s}from"./CharacterCard-B9aYIilu.js";import{S as u}from"./SessionCard-ZDU_nDA7.js";import"./preload-helper-CwRszBsw.js";import"./CardActionToolbar-B15dp_3i.js";function _({direction:r,className:U}){return e.jsx("svg",{className:U,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round",children:r==="left"?e.jsx("polyline",{points:"15 18 9 12 15 6"}):e.jsx("polyline",{points:"9 18 15 12 9 6"})})}function m({children:r,className:U,gap:E=16,showArrows:Y=!0,showDots:Z=!1,scrollCount:k=1,"aria-label":ee="Carousel"}){const p=i.useRef(null),[ae,re]=i.useState(!1),[te,se]=i.useState(!1),[M,oe]=i.useState(0),[T,ne]=i.useState(0),j=le.Children.toArray(r),h=i.useCallback(()=>{const t=p.current;if(!t)return;const{scrollLeft:a,scrollWidth:n,clientWidth:A}=t,g=n-A;re(a>1),se(a<g-1);const c=t.children;if(c.length>0){ne(c.length);const y=g>0?a/g:0,R=Math.round(y*(c.length-1));oe(Math.min(Math.max(R,0),c.length-1))}},[]),ie=i.useCallback(t=>{const a=p.current;if(!a)return;const n=a.children;if(n.length<=1)return;const{scrollWidth:A,clientWidth:g}=a,c=A-g,R=t/(n.length-1)*c;a.scrollTo({left:R,behavior:"smooth"})},[]),I=i.useCallback(t=>{const a=p.current;if(!a)return;const n=a.children;if(n.length===0)return;const c=(n[0].offsetWidth+E)*k,y=t==="left"?a.scrollLeft-c:a.scrollLeft+c;a.scrollTo({left:y,behavior:"smooth"})},[E,k]);return i.useEffect(()=>{const t=p.current;if(!t)return;h();const a=()=>h();t.addEventListener("scroll",a,{passive:!0});const n=new ResizeObserver(()=>h());return n.observe(t),()=>{t.removeEventListener("scroll",a),n.disconnect()}},[h]),i.useEffect(()=>{h()},[r,h]),e.jsxs("div",{className:C("relative w-full",U),role:"region","aria-label":ee,"aria-roledescription":"carousel",children:[e.jsx("div",{ref:p,className:C("flex overflow-x-auto scroll-smooth","scrollbar-none [-ms-overflow-style:none] [scrollbar-width:none]","[&::-webkit-scrollbar]:hidden","snap-x snap-mandatory lg:snap-none","px-4 lg:px-0"),style:{gap:`${E}px`},tabIndex:0,"aria-live":"polite",children:j.map((t,a)=>e.jsx("div",{className:C("flex-shrink-0 snap-start","w-[280px] sm:w-[300px] lg:w-[320px]"),role:"group","aria-roledescription":"slide","aria-label":`${a+1} of ${j.length}`,children:t},a))}),Y&&e.jsxs(e.Fragment,{children:[e.jsx("button",{onClick:()=>I("left"),disabled:!ae,className:C("absolute left-0 top-1/2 z-10 -translate-y-1/2 -translate-x-4","hidden lg:flex items-center justify-center","h-10 w-10 rounded-full","bg-zinc-800 border border-zinc-700","text-zinc-400 hover:text-white hover:bg-zinc-700","transition-all duration-200","disabled:opacity-0 disabled:pointer-events-none","focus:outline-none focus:ring-2 focus:ring-zinc-500"),"aria-label":"Previous items",children:e.jsx(_,{direction:"left",className:"h-5 w-5"})}),e.jsx("button",{onClick:()=>I("right"),disabled:!te,className:C("absolute right-0 top-1/2 z-10 -translate-y-1/2 translate-x-4","hidden lg:flex items-center justify-center","h-10 w-10 rounded-full","bg-zinc-800 border border-zinc-700","text-zinc-400 hover:text-white hover:bg-zinc-700","transition-all duration-200","disabled:opacity-0 disabled:pointer-events-none","focus:outline-none focus:ring-2 focus:ring-zinc-500"),"aria-label":"Next items",children:e.jsx(_,{direction:"right",className:"h-5 w-5"})})]}),Z&&T>1&&e.jsx("div",{className:"flex justify-center gap-2 mt-4",role:"tablist","aria-label":"Carousel navigation",children:Array.from({length:T}).map((t,a)=>e.jsx("button",{onClick:()=>ie(a),className:C("h-2 w-2 rounded-full transition-all duration-200","focus:outline-none focus:ring-2 focus:ring-zinc-500 focus:ring-offset-2 focus:ring-offset-zinc-900",a===M?"bg-white w-4":"bg-zinc-600 hover:bg-zinc-500"),role:"tab","aria-selected":a===M,"aria-label":`Go to slide ${a+1}`},a))})]})}m.__docgenInfo={description:`Carousel Component
