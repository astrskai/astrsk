import{r as ge,j as e}from"./iframe-f4JgoLz9.js";import{c as bt,f as Wt}from"./utils-CF6QUdYH.js";import{B as Ct,C as It,a as _t,b as he,c as Ft,d as kt,e as ae,S as re,f as At,D as vt,T as wt,L as n,g as Gt}from"./CardPopularityStats-CV4Ysjzc.js";import{S as s}from"./Skeleton-Dt3F622u.js";import{L as p}from"./lock-Bh8LfUWH.js";import{U as jt}from"./user-sqVPn02C.js";import{c as se}from"./createLucideIcon-Ba2hyEq9.js";import{M as Ht}from"./message-square-D6aBtu0W.js";import"./preload-helper-CwRszBsw.js";/**
 * @license lucide-react v0.503.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const qt=[["path",{d:"M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z",key:"c3ymky"}]],Yt=se("heart",qt);/**
 * @license lucide-react v0.503.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Jt=[["polygon",{points:"6 3 20 12 6 21 6 3",key:"1oa8hb"}]],i=se("play",Jt);/**
 * @license lucide-react v0.503.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Vt=[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"M12 5v14",key:"s699le"}]],l=se("plus",Vt),Lt=kt,te=ae;function r({name:t,imageUrl:Q,summary:oe,tags:g,tokenCount:St=0,updatedAt:ne,className:Et,actions:Nt=[],isDisabled:Dt=!1,onClick:Mt,badges:h=[],placeholderImageUrl:X,renderMetadata:ie,emptySummaryText:le="No summary",likeButton:ee,likeCount:ce,downloadCount:de,imageSizes:Pt,loading:Tt="lazy",footerActions:ue}){const[Ut,me]=ge.useState(!1);ge.useEffect(()=>{me(!1)},[Q,X]);const pe=(Q||X)&&!Ut,Rt=!pe;return e.jsxs(Ct,{className:bt("min-h-[380px]",Et),isDisabled:Dt,onClick:Mt,children:[e.jsxs("div",{className:"relative h-64 overflow-hidden bg-zinc-800",children:[pe&&e.jsx("img",{src:Q||X,alt:t,sizes:Pt,className:"absolute inset-0 h-full w-full object-cover transition-transform duration-500 group-hover:scale-105",loading:Tt,onError:()=>me(!0)}),Rt&&e.jsx("div",{className:"absolute inset-0 flex items-center justify-center",children:e.jsx("span",{className:"text-6xl font-bold text-zinc-500",children:t.charAt(0).toUpperCase()||"?"})}),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-zinc-900 via-transparent to-transparent opacity-90"}),ee&&e.jsx("div",{className:"absolute top-2 right-2 z-20",children:e.jsx(It,{...ee})}),e.jsx(_t,{actions:Nt,className:ee?"top-12":void 0}),h.some(c=>(c.position??"left")==="left")&&e.jsx("div",{className:"absolute top-3 left-3 z-10 max-w-[45%]",children:e.jsx(he,{badges:h,position:"left"})}),h.some(c=>c.position==="right")&&e.jsx("div",{className:"absolute top-3 right-3 z-10 max-w-[45%]",children:e.jsx(he,{badges:h,position:"right"})})]}),e.jsxs("div",{className:"relative z-10 -mt-12 flex flex-grow flex-col p-4",children:[e.jsx("h3",{className:"mb-1 line-clamp-2 text-lg md:text-xl font-bold break-words text-white drop-shadow-md",children:t}),e.jsx("div",{className:"mb-2 md:mb-4 flex flex-wrap gap-2",children:g.length>0?e.jsxs(e.Fragment,{children:[g.slice(0,3).map((c,Bt)=>e.jsx("span",{className:"rounded border border-zinc-700/50 bg-zinc-800/80 px-1.5 py-0.5 text-[10px] text-zinc-300",children:c},`${c}-${Bt}`)),g.length>3&&e.jsxs("span",{className:"rounded border border-zinc-700/50 bg-zinc-800/80 px-1.5 py-0.5 text-[10px] text-zinc-300",children:["+",g.length-3]})]}):e.jsx("span",{className:"text-[10px] text-zinc-400",children:"No tags"})}),(oe||le)&&e.jsx("p",{className:"mb-2 md:mb-4 line-clamp-2 flex-grow text-xs leading-relaxed break-all text-ellipsis text-zinc-400",children:oe||le}),(ce!==void 0||de!==void 0)&&e.jsx(Ft,{likeCount:ce,downloadCount:de,className:"mb-2"}),ie?ie():e.jsxs(kt,{children:[e.jsxs(ae,{children:[Wt(St)," Tokens"]}),ne&&e.jsx(ae,{children:ne})]})]}),ue&&e.jsx("div",{className:"mt-auto flex border-t border-zinc-800",children:ue})]})}r.__docgenInfo={description:"",methods:[],displayName:"CharacterCard",props:{name:{required:!0,tsType:{name:"string"},description:"Character name"},imageUrl:{required:!1,tsType:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}]},description:"Character image URL"},summary:{required:!1,tsType:{name:"string"},description:"Character summary/description"},tags:{required:!0,tsType:{name:"Array",elements:[{name:"string"}],raw:"string[]"},description:"Character tags"},tokenCount:{required:!1,tsType:{name:"number"},description:"Token count for the character (used in default metadata)",defaultValue:{value:"0",computed:!1}},updatedAt:{required:!1,tsType:{name:"string"},description:"Last updated timestamp (used in default metadata)"},actions:{required:!1,tsType:{name:"Array",elements:[{name:"CardAction"}],raw:"CardAction[]"},description:"Action buttons displayed on the card",defaultValue:{value:"[]",computed:!1}},className:{required:!1,tsType:{name:"string"},description:"Additional CSS classes"},isDisabled:{required:!1,tsType:{name:"boolean"},description:"Whether the card is disabled",defaultValue:{value:"false",computed:!1}},onClick:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"Click handler for the card"},badges:{required:!1,tsType:{name:"Array",elements:[{name:"CardBadge"}],raw:"CardBadge[]"},description:"Badges to display on the card (e.g., type indicator, private, owner).",defaultValue:{value:"[]",computed:!1}},placeholderImageUrl:{required:!1,tsType:{name:"string"},description:"Placeholder image URL when imageUrl is not provided"},renderMetadata:{required:!1,tsType:{name:"signature",type:"function",raw:"() => React.ReactNode",signature:{arguments:[],return:{name:"ReactReactNode",raw:"React.ReactNode"}}},description:`Custom render function for the metadata section.
...
@default 'lazy'`,defaultValue:{value:"'lazy'",computed:!1}},footerActions:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:`Custom footer actions to display at the bottom of the card.
...
}`,...(Re=(Ue=k.parameters)==null?void 0:Ue.docs)==null?void 0:Re.source}}};var Be,We,Ie;A.parameters={...A.parameters,docs:{...(Be=A.parameters)==null?void 0:Be.docs,source:{originalSource:`{
  args: {
...
}`,...(Ie=(We=A.parameters)==null?void 0:We.docs)==null?void 0:Ie.source}}};var _e,Fe,Ge;v.parameters={...v.parameters,docs:{...(_e=v.parameters)==null?void 0:_e.docs,source:{originalSource:`{
  args: {
    name: 'Alice Wonderland',
...
}`,...(ca=(la=N.parameters)==null?void 0:la.docs)==null?void 0:ca.source}}};var da,ua,ma;D.parameters={...D.parameters,docs:{...(da=D.parameters)==null?void 0:da.docs,source:{originalSource:`{
  args: {
...
}`,...(ma=(ua=D.parameters)==null?void 0:ua.docs)==null?void 0:ma.source}}};var pa,ga,ha;M.parameters={...M.parameters,docs:{...(pa=M.parameters)==null?void 0:pa.docs,source:{originalSource:`{
  args: {
...
}`,...(za=(La=R.parameters)==null?void 0:La.docs)==null?void 0:za.source}}};var Sa,Ea,Na;B.parameters={...B.parameters,docs:{...(Sa=B.parameters)==null?void 0:Sa.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    likeButton: {
      isLiked: true,
...
}`,...(Na=(Ea=B.parameters)==null?void 0:Ea.docs)==null?void 0:Na.source}}};var Da,Ma,Pa;W.parameters={...W.parameters,docs:{...(Da=W.parameters)==null?void 0:Da.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    likeCount: 1234
  }
}`,...(Pa=(Ma=W.parameters)==null?void 0:Ma.docs)==null?void 0:Pa.source}}};var Ta,Ua,Ra;I.parameters={...I.parameters,docs:{...(Ta=I.parameters)==null?void 0:Ta.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    downloadCount: 5678
  }
}`,...(Ra=(Ua=I.parameters)==null?void 0:Ua.docs)==null?void 0:Ra.source}}};var Ba,Wa,Ia;_.parameters={..._.parameters,docs:{...(Ba=_.parameters)==null?void 0:Ba.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    likeCount: 1234,
    downloadCount: 5678
  }
}`,...(Ia=(Wa=_.parameters)==null?void 0:Wa.docs)==null?void 0:Ia.source}}};var _a,Fa,Ga;F.parameters={...F.parameters,docs:{...(_a=F.parameters)==null?void 0:_a.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    likeButton: {
      isLiked: false,
...
}`,...(ct=(lt=K.parameters)==null?void 0:lt.docs)==null?void 0:ct.source}}};var dt,ut,mt;$.parameters={...$.parameters,docs:{...(dt=$.parameters)==null?void 0:dt.docs,source:{originalSource:`{
  args: {
...
}`,...(mt=(ut=$.parameters)==null?void 0:ut.docs)==null?void 0:mt.source}}};var pt,gt,ht;O.parameters={...O.parameters,docs:{...(pt=O.parameters)==null?void 0:pt.docs,source:{originalSource:`{
  args: {
    ...Default.args
  },
  decorators: [Story => <div style={{
