import{c as s}from"./createLucideIcon-B9DlvHFp.js";import{j as n}from"./iframe-hUBzdzut.js";import{c as d}from"./utils-DuMXYCiK.js";/**
...
- Click interaction support`,methods:[],displayName:"BaseCard",props:{children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},className:{required:!1,tsType:{name:"string"},description:""},isDisabled:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},onClick:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};function f({actions:a,className:r}){const o=e=>t=>{t.stopPropagation(),e.disabled||e.onClick(t)};return a.length===0?null:n.jsx("div",{className:d("absolute top-2 right-2 z-20 flex translate-y-0 items-center gap-1 rounded-lg border border-white/10 bg-black/60 p-1 opacity-100 backdrop-blur-md transition-all duration-300 lg:translate-y-[-10px] lg:opacity-0 lg:group-hover:translate-y-0 lg:group-hover:opacity-100",r),children:a.map((e,t)=>{const i=e.icon;return n.jsx("button",{onClick:o(e),className:d("rounded p-1.5 text-zinc-400 transition-colors hover:bg-white/10 hover:text-white",e.disabled&&"cursor-not-allowed opacity-50",e.loading&&"animate-pulse",e.className),title:e.title||e.label,disabled:e.disabled,children:n.jsx(i,{className:"h-4 w-4"})},t)})})}f.__docgenInfo={description:`Card Action Toolbar Component (Internal)
Desktop: Hidden by default, shows on hover
Mobile: Always visible`,methods:[],displayName:"CardActionToolbar",props:{actions:{required:!0,tsType:{name:"Array",elements:[{name:"CardAction"}],raw:"CardAction[]"},description:""},className:{required:!1,tsType:{name:"string"},description:""}}};function g({children:a}){return n.jsx("div",{className:"mt-auto flex items-center justify-between border-t border-zinc-800 pt-3 text-xs text-zinc-500",children:a})}function b({icon:a,children:r}){return n.jsxs("div",{className:"flex items-center gap-1",children:[a,r]})}g.__docgenInfo={description:`Container for metadata items in card components.
