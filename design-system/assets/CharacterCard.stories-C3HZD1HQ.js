import{j as e}from"./iframe-DqNV0hSL.js";import{C as s,M as ke,a as M}from"./CharacterCard-Do8K-CsG.js";import{c as Me}from"./utils-DuMXYCiK.js";import{B as be}from"./CardMetadata-ChNLDPxO.js";import{S as r}from"./Skeleton-C7Q_XKaG.js";import{S as je,C as Ee,D as De,T as Le,a as Ne}from"./trash-2-Disffz_p.js";import{c as Ie}from"./createLucideIcon-BURjcAwH.js";import{M as Te}from"./message-square-DIqog87y.js";import"./preload-helper-CwRszBsw.js";function o({className:a}){return e.jsxs(be,{className:Me("min-h-[380px]",a),isDisabled:!0,children:[e.jsx("div",{className:"relative h-64 overflow-hidden bg-zinc-800",children:e.jsx(r,{className:"absolute inset-0 h-full w-full",variant:"default"})}),e.jsxs("div",{className:"relative z-10 -mt-12 flex flex-grow flex-col p-4",children:[e.jsx(r,{className:"mb-1 h-6 w-3/4"}),e.jsxs("div",{className:"mb-4 flex flex-wrap gap-2",children:[e.jsx(r,{className:"h-5 w-12"}),e.jsx(r,{className:"h-5 w-16"}),e.jsx(r,{className:"h-5 w-10"})]}),e.jsxs("div",{className:"mb-4 flex-grow space-y-2",children:[e.jsx(r,{className:"h-3 w-full"}),e.jsx(r,{className:"h-3 w-full"}),e.jsx(r,{className:"h-3 w-2/3"})]}),e.jsxs("div",{className:"flex items-center gap-2 border-t border-zinc-800 pt-3",children:[e.jsx(r,{className:"h-3 w-16"}),e.jsx(r,{className:"h-3 w-20"})]})]})]})}o.displayName="CharacterCardSkeleton";o.__docgenInfo={description:`CharacterCardSkeleton Component
...
}`,...(E=(j=t.parameters)==null?void 0:j.docs)==null?void 0:E.source}}};var D,L,N;i.parameters={...i.parameters,docs:{...(D=i.parameters)==null?void 0:D.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    showTypeIndicator: true
  }
}`,...(N=(L=i.parameters)==null?void 0:L.docs)==null?void 0:N.source}}};var I,T,U;c.parameters={...c.parameters,docs:{...(I=c.parameters)==null?void 0:I.docs,source:{originalSource:`{
  args: {
...
}`,...(W=(P=d.parameters)==null?void 0:P.docs)==null?void 0:W.source}}};var G,z,R;l.parameters={...l.parameters,docs:{...(G=l.parameters)==null?void 0:G.docs,source:{originalSource:`{
  args: {
    name: 'Alice Wonderland',
...
}`,...(R=(z=l.parameters)==null?void 0:z.docs)==null?void 0:R.source}}};var F,B,H;m.parameters={...m.parameters,docs:{...(F=m.parameters)==null?void 0:F.docs,source:{originalSource:`{
  args: {
...
}`,...(K=(q=h.parameters)==null?void 0:q.docs)==null?void 0:K.source}}};var O,Y,$;u.parameters={...u.parameters,docs:{...(O=u.parameters)==null?void 0:O.docs,source:{originalSource:`{
  args: {
...
}`,...($=(Y=u.parameters)==null?void 0:Y.docs)==null?void 0:$.source}}};var V,Z,Q;g.parameters={...g.parameters,docs:{...(V=g.parameters)==null?void 0:V.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    isDisabled: true
  }
...
}`,...(ye=(pe=v.parameters)==null?void 0:pe.docs)==null?void 0:ye.source}}};var Ce,xe,Ae;f.parameters={...f.parameters,docs:{...(Ce=f.parameters)==null?void 0:Ce.docs,source:{originalSource:`{
  args: {
    ...Default.args
  },
  decorators: [Story => <div style={{
...
}`,...(Ae=(xe=f.parameters)==null?void 0:xe.docs)==null?void 0:Ae.source}}};var ve,fe,we;w.parameters={...w.parameters,docs:{...(ve=w.parameters)==null?void 0:ve.docs,source:{originalSource:`{
  args: {
    ...Default.args
  },
  decorators: [Story => <div style={{
...
}`,...(we=(fe=w.parameters)==null?void 0:fe.docs)==null?void 0:we.source}}};const Ke=["Default","WithTypeIndicator","WithoutImage","WithPlaceholder","ImageError","ManyTags","NoTags","LongName","Disabled","WithActions","GridLayout","CustomMetadata","MetadataWithIcons","FullyCustomMetadata","AllStates","Skeleton","SkeletonGrid"];export{v as AllStates,C as CustomMetadata,t as Default,g as Disabled,A as FullyCustomMetadata,y as GridLayout,l as ImageError,u as LongName,m as ManyTags,x as MetadataWithIcons,h as NoTags,f as Skeleton,w as SkeletonGrid,p as WithActions,d as WithPlaceholder,i as WithTypeIndicator,c as WithoutImage,Ke as __namedExportsOrder,qe as default};
