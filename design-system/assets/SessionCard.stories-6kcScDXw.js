import{r as he,j as e}from"./iframe-BJvbiKX9.js";import{c}from"./utils-CF6QUdYH.js";import{u as ft,B as nt,C as At,a as Ct,b as Ue,c as kt,d as bt,e as yt,S as Ce,f as it,D as ot,T as lt,L as n,g as ct}from"./useImageRenderer-B15Ko1MV.js";import{S as u}from"./Skeleton-Dqjw9VDS.js";import{L as l}from"./lock-BpfMZL7z.js";import{U as x}from"./user-BIT0Pe1w.js";import{S as xe,U as jt}from"./users-sIPRON6f.js";import"./preload-helper-CwRszBsw.js";import"./createLucideIcon-11CYeDgL.js";function Lt({name:s,avatarUrl:p,loading:S="lazy"}){const[h,C]=he.useState(!1);he.useEffect(()=>{C(!1)},[p]);const Se=p&&!h;return e.jsx("div",{className:"flex h-8 w-8 items-center justify-center overflow-hidden rounded-full border-2 border-zinc-900 bg-zinc-700",title:s,children:Se?e.jsx("img",{src:p,alt:s,className:"h-full w-full object-cover",loading:S,onError:()=>C(!0)}):e.jsx("span",{className:"text-[10px] text-zinc-400",children:s.charAt(0).toUpperCase()||"?"})})}function Ae(){return e.jsx("div",{className:"h-8 w-8 animate-pulse rounded-full border-2 border-zinc-900 bg-zinc-700"})}function Et({className:s}){return e.jsx("svg",{className:s,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round",children:e.jsx("path",{d:"M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"})})}const dt=bt,ve=yt;function o({title:s,imageUrl:p,placeholderImageUrl:S,messageCount:h,actions:C=[],className:Se,isDisabled:ke=!1,onClick:be,characterAvatars:k=[],areCharactersLoading:ye=!1,badges:b=[],renderMetadata:je,tags:m=[],summary:Le,likeButton:y,likeCount:Ee,downloadCount:we,imageSizes:ut,loading:gt="lazy",priority:ze=!1,renderImage:pt,classNames:t}){const[ht,Me]=he.useState(!1),vt=ft({renderImage:pt});he.useEffect(()=>{Me(!1)},[p,S]);const xt=(p||S)&&!ht,St=()=>{const r=p||S;return r?vt({src:r,alt:s,className:"absolute inset-0 h-full w-full object-cover opacity-80 transition-all duration-700 group-hover:scale-105 group-hover:opacity-90",sizes:ut,loading:ze?void 0:gt,onError:()=>Me(!0),fill:!0,priority:ze}):null};return e.jsxs(nt,{className:c("min-h-[320px] w-full bg-zinc-900 border-zinc-800 ring-1 ring-zinc-800/50 hover:border-zinc-600",!ke&&be&&"hover:ring-zinc-700",Se),isDisabled:ke,onClick:be,children:[e.jsxs("div",{className:"relative h-48 overflow-hidden bg-zinc-800",children:[xt?e.jsxs(e.Fragment,{children:[St(),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-zinc-900 via-zinc-900/40 to-transparent"})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"absolute inset-0 flex items-center justify-center",children:e.jsx("span",{className:"text-6xl font-bold text-zinc-500",children:s.charAt(0).toUpperCase()||"?"})}),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-zinc-900 to-transparent"})]}),y&&e.jsx("div",{className:"absolute top-2 right-2 z-20",children:e.jsx(At,{...y})}),e.jsx(Ct,{actions:C,className:y?"top-12":void 0}),b.some(r=>(r.position??"left")==="left")&&e.jsx("div",{className:"absolute top-3 left-3 z-10 max-w-[45%]",children:e.jsx(Ue,{badges:b,position:"left"})}),!y&&b.some(r=>r.position==="right")&&e.jsx("div",{className:"absolute top-3 right-3 z-10 max-w-[45%]",children:e.jsx(Ue,{badges:b,position:"right"})}),e.jsx("div",{className:"absolute bottom-0 left-0 w-full p-5",children:e.jsx("h2",{className:c("line-clamp-2 text-xl md:text-2xl leading-tight font-bold text-ellipsis text-white",t==null?void 0:t.title),children:s})})]}),e.jsx("div",{className:"flex flex-grow flex-col justify-between p-5",children:e.jsxs("div",{className:"space-y-2 md:space-y-3",children:[m.length>0&&e.jsxs("div",{className:c("flex flex-wrap gap-2",t==null?void 0:t.tagsContainer),children:[m.slice(0,2).map((r,fe)=>e.jsx("span",{className:c("max-w-[35%] @[240px]:max-w-[26%] truncate rounded border border-zinc-700/50 bg-zinc-800/80 px-1.5 py-0.5 text-[10px] text-zinc-300",t==null?void 0:t.tag),children:r},`${r}-${fe}`)),m[2]&&e.jsx("span",{className:c("hidden @[240px]:inline! max-w-[26%] truncate rounded border border-zinc-700/50 bg-zinc-800/80 px-1.5 py-0.5 text-[10px] text-zinc-300",t==null?void 0:t.tag),children:m[2]}),m.length>2&&e.jsxs("span",{className:c("@[240px]:hidden! shrink-0 rounded border border-zinc-700/50 bg-zinc-800/80 px-1.5 py-0.5 text-[10px] text-zinc-300",t==null?void 0:t.tag),children:["+",m.length-2]}),m.length>3&&e.jsxs("span",{className:c("hidden @[240px]:inline! shrink-0 rounded border border-zinc-700/50 bg-zinc-800/80 px-1.5 py-0.5 text-[10px] text-zinc-300",t==null?void 0:t.tag),children:["+",m.length-3]})]}),Le&&e.jsx("p",{className:c("line-clamp-2 text-xs leading-relaxed break-all text-ellipsis text-zinc-400",t==null?void 0:t.summary),children:Le}),(Ee!==void 0||we!==void 0)&&e.jsx(kt,{likeCount:Ee,downloadCount:we}),je?je():h!==void 0&&e.jsx("div",{className:"flex items-center justify-between text-sm",children:h===0?e.jsx("span",{className:"text-zinc-400",children:"New session"}):e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(Et,{className:"h-4 w-4 text-zinc-400"}),e.jsx("span",{className:"font-semibold text-zinc-300",children:h.toLocaleString()}),e.jsx("span",{className:"text-zinc-400",children:h===1?"Message":"Messages"})]})}),(ye||k.length>0)&&e.jsx("div",{className:"border-t border-zinc-800 pt-3",children:ye?e.jsxs("div",{className:"flex -space-x-2",children:[e.jsx(Ae,{}),e.jsx(Ae,{}),e.jsx(Ae,{})]}):e.jsxs("div",{className:"flex -space-x-2",children:[k.slice(0,3).map((r,fe)=>e.jsx(Lt,{name:r.name,avatarUrl:r.avatarUrl,loading:r.loading??"lazy"},`${r.name}-${fe}`)),k.length>3&&e.jsxs("div",{className:"flex h-8 w-8 items-center justify-center rounded-full border-2 border-zinc-900 bg-zinc-800 text-[10px] text-zinc-400",children:["+",k.length-3]})]})})]})})]})}o.__docgenInfo={description:"",methods:[],displayName:"SessionCard",props:{title:{required:!0,tsType:{name:"string"},description:"Session title"},imageUrl:{required:!1,tsType:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}]},description:"Cover image URL"},placeholderImageUrl:{required:!1,tsType:{name:"string"},description:"Placeholder image URL when imageUrl is not provided"},messageCount:{required:!1,tsType:{name:"number"},description:"Number of messages in the session (used in default metadata)"},actions:{required:!1,tsType:{name:"Array",elements:[{name:"CardAction"}],raw:"CardAction[]"},description:"Action buttons displayed on the card",defaultValue:{value:"[]",computed:!1}},className:{required:!1,tsType:{name:"string"},description:"Additional CSS classes"},isDisabled:{required:!1,tsType:{name:"boolean"},description:"Whether the card is disabled",defaultValue:{value:"false",computed:!1}},onClick:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"Click handler for the card"},characterAvatars:{required:!1,tsType:{name:"Array",elements:[{name:"CharacterAvatar"}],raw:"CharacterAvatar[]"},description:"Character avatars to display",defaultValue:{value:"[]",computed:!1}},areCharactersLoading:{required:!1,tsType:{name:"boolean"},description:"Whether characters are loading",defaultValue:{value:"false",computed:!1}},badges:{required:!1,tsType:{name:"Array",elements:[{name:"CardBadge"}],raw:"CardBadge[]"},description:"Badges to display on the card (e.g., type indicator, private, owner).",defaultValue:{value:"[]",computed:!1}},renderMetadata:{required:!1,tsType:{name:"signature",type:"function",raw:"() => React.ReactNode",signature:{arguments:[],return:{name:"ReactReactNode",raw:"React.ReactNode"}}},description:`Custom render function for the metadata section.
When provided, replaces the default messageCount display.
Use CardMetadataContainer and CardMetadataItem for consistent styling.`},tags:{required:!1,tsType:{name:"Array",elements:[{name:"string"}],raw:"string[]"},description:`Tags to display on the card.
...
/>
\`\`\``}}};function v({className:s}){return e.jsxs(nt,{className:c("min-h-[320px] w-full bg-zinc-900 border-zinc-800 ring-1 ring-zinc-800/50",s),isDisabled:!0,children:[e.jsxs("div",{className:"relative h-48 overflow-hidden bg-zinc-800",children:[e.jsx(u,{className:"absolute inset-0 h-full w-full",variant:"default"}),e.jsxs("div",{className:"absolute bottom-0 left-0 w-full p-5",children:[e.jsx(u,{className:"mb-2 h-7 w-3/4"}),e.jsx(u,{className:"h-7 w-1/2"})]})]}),e.jsx("div",{className:"flex flex-grow flex-col justify-between p-5",children:e.jsxs("div",{className:"space-y-3",children:[e.jsx("div",{className:"flex items-center justify-between border-b border-zinc-800 pb-2",children:e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(u,{className:"size-4",variant:"circular"}),e.jsx(u,{className:"h-4 w-20"})]})}),e.jsxs("div",{className:"flex -space-x-2 pt-1",children:[e.jsx(u,{className:"size-8 border-2 border-zinc-900",variant:"circular"}),e.jsx(u,{className:"size-8 border-2 border-zinc-900",variant:"circular"}),e.jsx(u,{className:"size-8 border-2 border-zinc-900",variant:"circular"})]})]})})]})}v.displayName="SessionCardSkeleton";v.__docgenInfo={description:`SessionCardSkeleton Component
...
}`,...(Te=(Be=a.parameters)==null?void 0:Be.docs)==null?void 0:Te.source}}};var Pe,De,_e;j.parameters={...j.parameters,docs:{...(Pe=j.parameters)==null?void 0:Pe.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    badges: [{
      label: 'SESSION',
...
}`,...(_e=(De=j.parameters)==null?void 0:De.docs)==null?void 0:_e.source}}};var Re,Ie,We;L.parameters={...L.parameters,docs:{...(Re=L.parameters)==null?void 0:Re.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    badges: [{
      label: 'SESSION',
...
}`,...(He=(Ge=w.parameters)==null?void 0:Ge.docs)==null?void 0:He.source}}};var Qe,$e,Je;z.parameters={...z.parameters,docs:{...(Qe=z.parameters)==null?void 0:Qe.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    badges: [{
      label: 'SESSION',
...
}`,...(Je=($e=z.parameters)==null?void 0:$e.docs)==null?void 0:Je.source}}};var Ke,Xe,Ye;M.parameters={...M.parameters,docs:{...(Ke=M.parameters)==null?void 0:Ke.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    badges: [{
      label: 'SESSION',
...
}`,...(da=(ca=T.parameters)==null?void 0:ca.docs)==null?void 0:da.source}}};var ma,ua,ga;P.parameters={...P.parameters,docs:{...(ma=P.parameters)==null?void 0:ma.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    title: 'Just Started',
    messageCount: 1
  }
}`,...(ga=(ua=P.parameters)==null?void 0:ua.docs)==null?void 0:ga.source}}};var pa,ha,va;D.parameters={...D.parameters,docs:{...(pa=D.parameters)==null?void 0:pa.docs,source:{originalSource:`{
  args: {
...
}`,...(va=(ha=D.parameters)==null?void 0:ha.docs)==null?void 0:va.source}}};var xa,Sa,fa;_.parameters={..._.parameters,docs:{...(xa=_.parameters)==null?void 0:xa.docs,source:{originalSource:`{
  args: {
...
}`,...(Ta=(Ba=O.parameters)==null?void 0:Ba.docs)==null?void 0:Ta.source}}};var Pa,Da,_a;F.parameters={...F.parameters,docs:{...(Pa=F.parameters)==null?void 0:Pa.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    actions: [{
      icon: Edit,
...
}`,...(_a=(Da=F.parameters)==null?void 0:Da.docs)==null?void 0:_a.source}}};var Ra,Ia,Wa;q.parameters={...q.parameters,docs:{...(Ra=q.parameters)==null?void 0:Ra.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    title: 'Epic Campaign',
    messageCount: 12345
...
}`,...(Ha=(Ga=H.parameters)==null?void 0:Ga.docs)==null?void 0:Ha.source}}};var Qa,$a,Ja;Q.parameters={...Q.parameters,docs:{...(Qa=Q.parameters)==null?void 0:Qa.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    title: 'Quick Session',
    tags: ['Casual']
  }
}`,...(Ja=($a=Q.parameters)==null?void 0:$a.docs)==null?void 0:Ja.source}}};var Ka,Xa,Ya;$.parameters={...$.parameters,docs:{...(Ka=$.parameters)==null?void 0:Ka.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    title: 'Epic Quest',
    summary: 'An immersive fantasy adventure where heroes embark on a dangerous journey to save the kingdom from ancient evil.'
  }
}`,...(Ya=(Xa=$.parameters)==null?void 0:Xa.docs)==null?void 0:Ya.source}}};var Za,es,as;J.parameters={...J.parameters,docs:{...(Za=J.parameters)==null?void 0:Za.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    title: 'Mystery Manor',
...
}`,...(as=(es=J.parameters)==null?void 0:es.docs)==null?void 0:as.source}}};var ss,ts,rs;K.parameters={...K.parameters,docs:{...(ss=K.parameters)==null?void 0:ss.docs,source:{originalSource:`{
  args: {
    ...Default.args
  },
...
}`,...(Ts=(Bs=ie.parameters)==null?void 0:Bs.docs)==null?void 0:Ts.source}}};var Ps,Ds,_s;oe.parameters={...oe.parameters,docs:{...(Ps=oe.parameters)==null?void 0:Ps.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    likeCount: 1234,
    downloadCount: 5678
  }
}`,...(_s=(Ds=oe.parameters)==null?void 0:Ds.docs)==null?void 0:_s.source}}};var Rs,Is,Ws;le.parameters={...le.parameters,docs:{...(Rs=le.parameters)==null?void 0:Rs.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    likeButton: {
      isLiked: false,
...
}`,...(Hs=(Gs=de.parameters)==null?void 0:Gs.docs)==null?void 0:Hs.source}}};var Qs,$s,Js;me.parameters={...me.parameters,docs:{...(Qs=me.parameters)==null?void 0:Qs.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    likeButton: {
      isLiked: true,
...
}`,...(Js=($s=me.parameters)==null?void 0:$s.docs)==null?void 0:Js.source}}};var Ks,Xs,Ys;ue.parameters={...ue.parameters,docs:{...(Ks=ue.parameters)==null?void 0:Ks.docs,source:{originalSource:`{
  args: {
