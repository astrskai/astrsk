import{r as me,j as e}from"./iframe-f4JgoLz9.js";import{c as Ys}from"./utils-CF6QUdYH.js";import{B as Zs,C as dt,a as mt,b as Ee,c as ut,d as gt,e as pt,S as Se,f as et,D as at,T as st,L as t,g as tt}from"./CardPopularityStats-CV4Ysjzc.js";import{S as d}from"./Skeleton-Dt3F622u.js";import{L as o}from"./lock-Bh8LfUWH.js";import{U as p}from"./user-sqVPn02C.js";import{S as ge,U as ht}from"./users-DYABF6R4.js";import"./preload-helper-CwRszBsw.js";import"./createLucideIcon-Ba2hyEq9.js";function vt({name:s,avatarUrl:c,loading:u="lazy"}){const[pe,x]=me.useState(!1);me.useEffect(()=>{x(!1)},[c]);const S=c&&!pe;return e.jsx("div",{className:"flex h-8 w-8 items-center justify-center overflow-hidden rounded-full border-2 border-zinc-900 bg-zinc-700",title:s,children:S?e.jsx("img",{src:c,alt:s,className:"h-full w-full object-cover",loading:u,onError:()=>x(!0)}):e.jsx("span",{className:"text-[10px] text-zinc-400",children:s.charAt(0).toUpperCase()||"?"})})}function xe(){return e.jsx("div",{className:"h-8 w-8 animate-pulse rounded-full border-2 border-zinc-900 bg-zinc-700"})}function xt({className:s}){return e.jsx("svg",{className:s,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round",children:e.jsx("path",{d:"M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"})})}const rt=gt,ue=pt;function i({title:s,imageUrl:c,messageCount:u,actions:pe=[],className:x,isDisabled:S=!1,onClick:Ae,characterAvatars:A=[],areCharactersLoading:fe=!1,badges:f=[],renderMetadata:Ce,tags:C=[],summary:ke,likeButton:he,likeCount:be,downloadCount:ye,imageSizes:it,loading:ot="lazy"}){const[je,Le]=me.useState(!1);me.useEffect(()=>{Le(!1)},[c]);const lt=c&&!je,ct=c&&je;return e.jsxs(Zs,{className:Ys("min-h-[320px] w-full border-zinc-700 ring-1 ring-zinc-800",!S&&Ae&&"hover:ring-zinc-600",x),isDisabled:S,onClick:Ae,children:[e.jsxs("div",{className:"relative h-48 overflow-hidden bg-zinc-800",children:[lt?e.jsxs(e.Fragment,{children:[e.jsx("img",{src:c,alt:s,sizes:it,className:"absolute inset-0 h-full w-full object-cover opacity-80 transition-all duration-700 group-hover:scale-105 group-hover:opacity-90",loading:ot,onError:()=>Le(!0)}),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-zinc-900 via-zinc-900/40 to-transparent"})]}):ct?e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"absolute inset-0 flex items-center justify-center",children:e.jsx("span",{className:"text-6xl font-bold text-zinc-500",children:s.charAt(0).toUpperCase()||"?"})}),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-zinc-900 to-transparent"})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"absolute inset-0 bg-zinc-800",children:e.jsx("div",{className:"absolute inset-0 opacity-20",style:{backgroundImage:"radial-gradient(#4f46e5 1px, transparent 1px)",backgroundSize:"16px 16px"}})}),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-zinc-900 to-transparent"})]}),he&&e.jsx("div",{className:"absolute top-2 right-2 z-20",children:e.jsx(dt,{...he})}),e.jsx(mt,{actions:pe,className:he?"top-12":void 0}),f.some(r=>(r.position??"left")==="left")&&e.jsx("div",{className:"absolute top-3 left-3 z-10 max-w-[45%]",children:e.jsx(Ee,{badges:f,position:"left"})}),f.some(r=>r.position==="right")&&e.jsx("div",{className:"absolute top-3 right-3 z-10 max-w-[45%]",children:e.jsx(Ee,{badges:f,position:"right"})}),e.jsx("div",{className:"absolute bottom-0 left-0 w-full p-5",children:e.jsx("h2",{className:"line-clamp-2 text-xl md:text-2xl leading-tight font-bold text-ellipsis text-white",children:s})})]}),e.jsx("div",{className:"flex flex-grow flex-col justify-between p-5",children:e.jsxs("div",{className:"space-y-2 md:space-y-3",children:[C.length>0&&e.jsxs("div",{className:"flex flex-wrap gap-2",children:[C.slice(0,3).map((r,ve)=>e.jsx("span",{className:"rounded border border-zinc-700/50 bg-zinc-800/80 px-1.5 py-0.5 text-[10px] text-zinc-300",children:r},`${r}-${ve}`)),C.length>3&&e.jsxs("span",{className:"rounded border border-zinc-700/50 bg-zinc-800/80 px-1.5 py-0.5 text-[10px] text-zinc-300",children:["+",C.length-3]})]}),ke&&e.jsx("p",{className:"line-clamp-2 text-xs leading-relaxed break-all text-ellipsis text-zinc-400",children:ke}),(be!==void 0||ye!==void 0)&&e.jsx(ut,{likeCount:be,downloadCount:ye}),Ce?Ce():u!==void 0&&e.jsx("div",{className:"flex items-center justify-between text-sm",children:u===0?e.jsx("span",{className:"text-zinc-400",children:"New session"}):e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(xt,{className:"h-4 w-4 text-zinc-400"}),e.jsx("span",{className:"font-semibold text-zinc-300",children:u.toLocaleString()}),e.jsx("span",{className:"text-zinc-400",children:u===1?"Message":"Messages"})]})}),(fe||A.length>0)&&e.jsx("div",{className:"border-t border-zinc-800 pt-3",children:fe?e.jsxs("div",{className:"flex -space-x-2",children:[e.jsx(xe,{}),e.jsx(xe,{}),e.jsx(xe,{})]}):e.jsxs("div",{className:"flex -space-x-2",children:[A.slice(0,3).map((r,ve)=>e.jsx(vt,{name:r.name,avatarUrl:r.avatarUrl,loading:r.loading??"lazy"},`${r.name}-${ve}`)),A.length>3&&e.jsxs("div",{className:"flex h-8 w-8 items-center justify-center rounded-full border-2 border-zinc-900 bg-zinc-800 text-[10px] text-zinc-400",children:["+",A.length-3]})]})})]})})]})}i.__docgenInfo={description:"",methods:[],displayName:"SessionCard",props:{title:{required:!0,tsType:{name:"string"},description:"Session title"},imageUrl:{required:!1,tsType:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}]},description:"Cover image URL"},messageCount:{required:!1,tsType:{name:"number"},description:"Number of messages in the session (used in default metadata)"},actions:{required:!1,tsType:{name:"Array",elements:[{name:"CardAction"}],raw:"CardAction[]"},description:"Action buttons displayed on the card",defaultValue:{value:"[]",computed:!1}},className:{required:!1,tsType:{name:"string"},description:"Additional CSS classes"},isDisabled:{required:!1,tsType:{name:"boolean"},description:"Whether the card is disabled",defaultValue:{value:"false",computed:!1}},onClick:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"Click handler for the card"},characterAvatars:{required:!1,tsType:{name:"Array",elements:[{name:"CharacterAvatar"}],raw:"CharacterAvatar[]"},description:"Character avatars to display",defaultValue:{value:"[]",computed:!1}},areCharactersLoading:{required:!1,tsType:{name:"boolean"},description:"Whether characters are loading",defaultValue:{value:"false",computed:!1}},badges:{required:!1,tsType:{name:"Array",elements:[{name:"CardBadge"}],raw:"CardBadge[]"},description:"Badges to display on the card (e.g., type indicator, private, owner).",defaultValue:{value:"[]",computed:!1}},renderMetadata:{required:!1,tsType:{name:"signature",type:"function",raw:"() => React.ReactNode",signature:{arguments:[],return:{name:"ReactReactNode",raw:"React.ReactNode"}}},description:`Custom render function for the metadata section.
...
}`,...(De=(Ue=k.parameters)==null?void 0:Ue.docs)==null?void 0:De.source}}};var Te,_e,Be;b.parameters={...b.parameters,docs:{...(Te=b.parameters)==null?void 0:Te.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    badges: [{
      label: 'SESSION',
...
}`,...(Be=(_e=b.parameters)==null?void 0:_e.docs)==null?void 0:Be.source}}};var Pe,Re,Ve;y.parameters={...y.parameters,docs:{...(Pe=y.parameters)==null?void 0:Pe.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    badges: [{
      label: 'SESSION',
...
}`,...(Ve=(Re=y.parameters)==null?void 0:Re.docs)==null?void 0:Ve.source}}};var Ie,We,Oe;j.parameters={...j.parameters,docs:{...(Ie=j.parameters)==null?void 0:Ie.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    badges: [{
      label: 'SESSION',
...
}`,...(Sa=(xa=_.parameters)==null?void 0:xa.docs)==null?void 0:Sa.source}}};var Aa,fa,Ca;B.parameters={...B.parameters,docs:{...(Aa=B.parameters)==null?void 0:Aa.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    title: 'Group Session',
    characterAvatars: [{
...
}`,...(Ca=(fa=B.parameters)==null?void 0:fa.docs)==null?void 0:Ca.source}}};var ka,ba,ya;P.parameters={...P.parameters,docs:{...(ka=P.parameters)==null?void 0:ka.docs,source:{originalSource:`{
  args: {
    ...Default.args,
...
}`,...(ya=(ba=P.parameters)==null?void 0:ba.docs)==null?void 0:ya.source}}};var ja,La,Ea;R.parameters={...R.parameters,docs:{...(ja=R.parameters)==null?void 0:ja.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    isDisabled: true
  }
}`,...(Ea=(La=R.parameters)==null?void 0:La.docs)==null?void 0:Ea.source}}};var wa,Ma,za;V.parameters={...V.parameters,docs:{...(wa=V.parameters)==null?void 0:wa.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    title: 'The Exceptionally Long Session Title That Should Be Truncated After Two Lines'
  }
}`,...(za=(Ma=V.parameters)==null?void 0:Ma.docs)==null?void 0:za.source}}};var Na,Ua,Da;I.parameters={...I.parameters,docs:{...(Na=I.parameters)==null?void 0:Na.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    actions: [{
      icon: Edit,
...
}`,...(Da=(Ua=I.parameters)==null?void 0:Ua.docs)==null?void 0:Da.source}}};var Ta,_a,Ba;W.parameters={...W.parameters,docs:{...(Ta=W.parameters)==null?void 0:Ta.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    title: 'Epic Campaign',
    messageCount: 12345
  }
}`,...(Ba=(_a=W.parameters)==null?void 0:_a.docs)==null?void 0:Ba.source}}};var Pa,Ra,Va;O.parameters={...O.parameters,docs:{...(Pa=O.parameters)==null?void 0:Pa.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    title: 'Fantasy Adventure',
    tags: ['Fantasy', 'Adventure', 'RPG']
  }
}`,...(Va=(Ra=O.parameters)==null?void 0:Ra.docs)==null?void 0:Va.source}}};var Ia,Wa,Oa;F.parameters={...F.parameters,docs:{...(Ia=F.parameters)==null?void 0:Ia.docs,source:{originalSource:`{
  args: {
    ...Default.args,
...
}`,...(Ds=(Us=re.parameters)==null?void 0:Us.docs)==null?void 0:Ds.source}}};var Ts,_s,Bs;ne.parameters={...ne.parameters,docs:{...(Ts=ne.parameters)==null?void 0:Ts.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    likeButton: {
      isLiked: false,
...
}`,...(Bs=(_s=ne.parameters)==null?void 0:_s.docs)==null?void 0:Bs.source}}};var Ps,Rs,Vs;ie.parameters={...ie.parameters,docs:{...(Ps=ie.parameters)==null?void 0:Ps.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    likeButton: {
      isLiked: true,
...
}`,...(Vs=(Rs=ie.parameters)==null?void 0:Rs.docs)==null?void 0:Vs.source}}};var Is,Ws,Os;oe.parameters={...oe.parameters,docs:{...(Is=oe.parameters)==null?void 0:Is.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    likeButton: {
      isLiked: false,
