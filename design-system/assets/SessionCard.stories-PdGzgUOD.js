import{j as e,r as Ce}from"./iframe-B-tfC-8l.js";import{c as d}from"./utils-CF6QUdYH.js";import{u as Bs,B as bs,C as _s,a as Rs,b as Be,c as Is,d as Vs,e as Ws,S as ke,f as ks,D as ys,T as S,L as n,g as js,P as ye}from"./useImageRenderer-zr1kc198.js";import{S as g}from"./Skeleton-gRrNde-x.js";import{L as l}from"./lock-Cf1nbULa.js";import{U as v}from"./user-B-ZTjVOG.js";import{S as je,U as Fs}from"./users-AI80kcNz.js";import"./preload-helper-CwRszBsw.js";import"./createLucideIcon-ZUb9qfVY.js";function zs({name:t,avatarUrl:p,loading:f="lazy"}){const[ze,C]=Ce.useState(!1);Ce.useEffect(()=>{C(!1)},[p]);const b=p&&!ze;return e.jsx("div",{className:"flex h-10 w-10 items-center justify-center overflow-hidden rounded-full border-2 border-zinc-900 bg-zinc-700",title:t,children:b?e.jsx("img",{src:p,alt:t,className:"h-full w-full object-cover",loading:f,onError:()=>C(!0)}):e.jsx("span",{className:"text-xs text-zinc-400",children:t.charAt(0).toUpperCase()||"?"})})}function Ae(){return e.jsx("div",{className:"h-10 w-10 animate-pulse rounded-full border-2 border-zinc-900 bg-zinc-700"})}zs.__docgenInfo={description:`Character Avatar Component
