import{r as ne,j as e}from"./iframe-nd82mxMM.js";import{c as $a}from"./utils-DuMXYCiK.js";import{B as Ya,C as pt,a as ht,b as oe,c as Ct,d as Za,e as O,S as Y,f as Qa,D as Xa,T as et,L as n,g as kt}from"./CardPopularityStats-Cb1_bQJq.js";import{S as s}from"./Skeleton-BDqcFJl8.js";import{L as c}from"./lock-EzJIr1Eg.js";import{U as at}from"./user-CyzVLqJ7.js";import{c as yt}from"./createLucideIcon-uc2vxrGM.js";import{M as xt}from"./message-square-D-YdxFUQ.js";import"./preload-helper-CwRszBsw.js";/**
 * @license lucide-react v0.503.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ft=[["path",{d:"M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z",key:"c3ymky"}]],At=yt("heart",ft),tt=Za,$=O;function r({name:t,imageUrl:V,summary:Z,tags:u,tokenCount:st=0,updatedAt:Q,className:nt,actions:ot=[],isDisabled:it=!1,onClick:lt,badges:g=[],placeholderImageUrl:J,renderMetadata:X,emptySummaryText:ee="No summary",likeButton:K,likeCount:ae,downloadCount:te,imageSizes:ct,loading:dt="lazy"}){const[mt,re]=ne.useState(!1);ne.useEffect(()=>{re(!1)},[V,J]);const se=(V||J)&&!mt,ut=!se;return e.jsxs(Ya,{className:$a("min-h-[380px]",nt),isDisabled:it,onClick:lt,children:[e.jsxs("div",{className:"relative h-64 overflow-hidden bg-zinc-800",children:[se&&e.jsx("img",{src:V||J,alt:t,sizes:ct,className:"absolute inset-0 h-full w-full object-cover transition-transform duration-500 group-hover:scale-105",loading:dt,onError:()=>re(!0)}),ut&&e.jsx("div",{className:"absolute inset-0 flex items-center justify-center",children:e.jsx("span",{className:"text-6xl font-bold text-zinc-500",children:t.charAt(0).toUpperCase()||"?"})}),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-zinc-900 via-transparent to-transparent opacity-90"}),K&&e.jsx("div",{className:"absolute top-2 right-2 z-20",children:e.jsx(pt,{...K})}),e.jsx(ht,{actions:ot,className:K?"top-12":void 0}),g.some(i=>(i.position??"left")==="left")&&e.jsx("div",{className:"absolute top-3 left-3 z-10 max-w-[45%]",children:e.jsx(oe,{badges:g,position:"left"})}),g.some(i=>i.position==="right")&&e.jsx("div",{className:"absolute top-3 right-3 z-10 max-w-[45%]",children:e.jsx(oe,{badges:g,position:"right"})})]}),e.jsxs("div",{className:"relative z-10 -mt-12 flex flex-grow flex-col p-4",children:[e.jsx("h3",{className:"mb-1 line-clamp-2 text-lg md:text-xl font-bold break-words text-white drop-shadow-md",children:t}),e.jsx("div",{className:"mb-2 md:mb-4 flex flex-wrap gap-2",children:u.length>0?e.jsxs(e.Fragment,{children:[u.slice(0,3).map((i,gt)=>e.jsx("span",{className:"rounded border border-zinc-700/50 bg-zinc-800/80 px-1.5 py-0.5 text-[10px] text-zinc-300",children:i},`${i}-${gt}`)),u.length>3&&e.jsxs("span",{className:"rounded border border-zinc-700/50 bg-zinc-800/80 px-1.5 py-0.5 text-[10px] text-zinc-300",children:["+",u.length-3]})]}):e.jsx("span",{className:"text-[10px] text-zinc-400",children:"No tags"})}),(Z||ee)&&e.jsx("p",{className:"mb-2 md:mb-4 line-clamp-2 flex-grow text-xs leading-relaxed break-all text-ellipsis text-zinc-400",children:Z||ee}),(ae!==void 0||te!==void 0)&&e.jsx(Ct,{likeCount:ae,downloadCount:te,className:"mb-2"}),X?X():e.jsxs(Za,{children:[e.jsxs(O,{children:[st," Tokens"]}),Q&&e.jsx(O,{children:Q})]})]})]})}r.__docgenInfo={description:"",methods:[],displayName:"CharacterCard",props:{name:{required:!0,tsType:{name:"string"},description:"Character name"},imageUrl:{required:!1,tsType:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}]},description:"Character image URL"},summary:{required:!1,tsType:{name:"string"},description:"Character summary/description"},tags:{required:!0,tsType:{name:"Array",elements:[{name:"string"}],raw:"string[]"},description:"Character tags"},tokenCount:{required:!1,tsType:{name:"number"},description:"Token count for the character (used in default metadata)",defaultValue:{value:"0",computed:!1}},updatedAt:{required:!1,tsType:{name:"string"},description:"Last updated timestamp (used in default metadata)"},actions:{required:!1,tsType:{name:"Array",elements:[{name:"CardAction"}],raw:"CardAction[]"},description:"Action buttons displayed on the card",defaultValue:{value:"[]",computed:!1}},className:{required:!1,tsType:{name:"string"},description:"Additional CSS classes"},isDisabled:{required:!1,tsType:{name:"boolean"},description:"Whether the card is disabled",defaultValue:{value:"false",computed:!1}},onClick:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"Click handler for the card"},badges:{required:!1,tsType:{name:"Array",elements:[{name:"CardBadge"}],raw:"CardBadge[]"},description:"Badges to display on the card (e.g., type indicator, private, owner).",defaultValue:{value:"[]",computed:!1}},placeholderImageUrl:{required:!1,tsType:{name:"string"},description:"Placeholder image URL when imageUrl is not provided"},renderMetadata:{required:!1,tsType:{name:"signature",type:"function",raw:"() => React.ReactNode",signature:{arguments:[],return:{name:"ReactReactNode",raw:"React.ReactNode"}}},description:`Custom render function for the metadata section.
...
}`,...(Ge=(Fe=w.parameters)==null?void 0:Fe.docs)==null?void 0:Ge.source}}};var He,qe,Ve;L.parameters={...L.parameters,docs:{...(He=L.parameters)==null?void 0:He.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    isDisabled: true
  }
}`,...(Ve=(qe=L.parameters)==null?void 0:qe.docs)==null?void 0:Ve.source}}};var Je,Ke,Oe;E.parameters={...E.parameters,docs:{...(Je=E.parameters)==null?void 0:Je.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    actions: [{
      icon: Edit,
...
}`,...(Ga=(Fa=G.parameters)==null?void 0:Fa.docs)==null?void 0:Ga.source}}};var Ha,qa,Va;H.parameters={...H.parameters,docs:{...(Ha=H.parameters)==null?void 0:Ha.docs,source:{originalSource:`{
  args: {
    name: 'Alice Wonderland',
    imageUrl: SAMPLE_IMAGE,
    summary: 'A curious young girl who falls down a rabbit hole into a fantasy world populated by peculiar creatures.',
...
}`,...(Va=(qa=H.parameters)==null?void 0:qa.docs)==null?void 0:Va.source}}};var Ja,Ka,Oa;q.parameters={...q.parameters,docs:{...(Ja=q.parameters)==null?void 0:Ja.docs,source:{originalSource:`{
  args: {
    ...Default.args
  },
  decorators: [Story => <div style={{
