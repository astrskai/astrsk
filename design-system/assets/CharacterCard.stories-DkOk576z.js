import{r as be,j as e}from"./iframe-BLXYQOJY.js";import{c as l,f as ar}from"./utils-CF6QUdYH.js";import{u as tr,B as Tt,C as rr,a as sr,b as ke,c as or,d as Rt,e as ne,S as le,f as Ut,D as Bt,T as It,L as c,g as nr}from"./useImageRenderer-CVu9TpCS.js";import{S as o}from"./Skeleton-WstXSMPt.js";import{L as h}from"./lock-BC96AgFT.js";import{U as Wt}from"./user-DKq_kOnq.js";import{c as ce}from"./createLucideIcon-BAmFGolA.js";import{M as ir}from"./message-square-BLWmRP0i.js";import"./preload-helper-CwRszBsw.js";/**
 * @license lucide-react v0.503.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const lr=[["path",{d:"M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z",key:"c3ymky"}]],cr=ce("heart",lr);/**
 * @license lucide-react v0.503.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const dr=[["polygon",{points:"6 3 20 12 6 21 6 3",key:"1oa8hb"}]],u=ce("play",dr);/**
 * @license lucide-react v0.503.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ur=[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"M12 5v14",key:"s699le"}]],m=ce("plus",ur),_t=Rt,ie=ne;function s({name:t,imageUrl:se,summary:de,tags:d,tokenCount:Gt=0,updatedAt:ue,className:Ht,actions:qt=[],isDisabled:Yt=!1,onClick:Jt,badges:y=[],placeholderImageUrl:oe,renderMetadata:me,emptySummaryText:pe="No summary",likeButton:f,likeCount:ge,downloadCount:he,imageSizes:Vt,loading:Kt="lazy",priority:xe=!1,footerActions:ye,renderImage:$t,classNames:r}){const[Qt,fe]=be.useState(!1),Ot=tr({renderImage:$t});be.useEffect(()=>{fe(!1)},[se,oe]);const Ce=(se||oe)&&!Qt,Zt=!Ce,Xt=()=>{const i=se||oe;return i?Ot({src:i,alt:t,className:"absolute inset-0 h-full w-full object-cover transition-transform duration-500 group-hover:scale-105",sizes:Vt,loading:xe?void 0:Kt,onError:()=>fe(!0),fill:!0,priority:xe}):null};return e.jsxs(Tt,{className:l("min-h-[380px] bg-zinc-900 border-zinc-800 hover:border-zinc-600",Ht),isDisabled:Yt,onClick:Jt,children:[e.jsxs("div",{className:"relative h-64 overflow-hidden bg-zinc-800",children:[Ce&&Xt(),Zt&&e.jsx("div",{className:"absolute inset-0 flex items-center justify-center",children:e.jsx("span",{className:"text-6xl font-bold text-zinc-500",children:t.charAt(0).toUpperCase()||"?"})}),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-zinc-900 via-zinc-900/40 to-transparent"}),f&&e.jsx("div",{className:"absolute top-2 right-2 z-20",children:e.jsx(rr,{...f})}),e.jsx(sr,{actions:qt,className:f?"top-12":void 0}),y.some(i=>(i.position??"left")==="left")&&e.jsx("div",{className:"absolute top-3 left-3 z-10 max-w-[45%]",children:e.jsx(ke,{badges:y,position:"left"})}),!f&&y.some(i=>i.position==="right")&&e.jsx("div",{className:"absolute top-3 right-3 z-10 max-w-[45%]",children:e.jsx(ke,{badges:y,position:"right"})})]}),e.jsxs("div",{className:"relative z-10 -mt-12 flex flex-grow flex-col p-4",children:[e.jsx("h3",{className:l("mb-1 line-clamp-2 text-lg md:text-xl font-bold break-words text-white drop-shadow-md",r==null?void 0:r.name),children:t}),e.jsx("div",{className:l("mb-2 @[240px]:mb-4 flex flex-wrap gap-2",r==null?void 0:r.tagsContainer),children:d.length>0?e.jsxs(e.Fragment,{children:[d.slice(0,2).map((i,er)=>e.jsx("span",{className:l("max-w-[28%] @[240px]:max-w-[21%] truncate rounded border border-zinc-700/50 bg-zinc-800/80 px-1.5 py-0.5 text-[10px] text-zinc-300",r==null?void 0:r.tag),children:i},`${i}-${er}`)),d[2]&&e.jsx("span",{className:l("hidden @[240px]:inline max-w-[21%] truncate rounded border border-zinc-700/50 bg-zinc-800/80 px-1.5 py-0.5 text-[10px] text-zinc-300",r==null?void 0:r.tag),children:d[2]}),d.length>2&&e.jsxs("span",{className:l("@[240px]:hidden shrink-0 rounded border border-zinc-700/50 bg-zinc-800/80 px-1.5 py-0.5 text-[10px] text-zinc-300",r==null?void 0:r.tag),children:["+",d.length-2]}),d.length>3&&e.jsxs("span",{className:l("hidden @[240px]:inline shrink-0 rounded border border-zinc-700/50 bg-zinc-800/80 px-1.5 py-0.5 text-[10px] text-zinc-300",r==null?void 0:r.tag),children:["+",d.length-3]})]}):e.jsx("span",{className:"text-[10px] text-zinc-400",children:"No tags"})}),(de||pe)&&e.jsx("p",{className:l("mb-2 md:mb-4 line-clamp-2 flex-grow text-xs leading-relaxed break-all text-ellipsis text-zinc-400",r==null?void 0:r.summary),children:de||pe}),(ge!==void 0||he!==void 0)&&e.jsx(or,{likeCount:ge,downloadCount:he,className:"mb-2"}),me?me():e.jsxs(Rt,{className:"border-zinc-800 text-zinc-400",children:[e.jsxs(ne,{children:[ar(Gt)," Tokens"]}),ue&&e.jsx(ne,{children:ue})]})]}),ye&&e.jsx("div",{className:"mt-auto flex border-t border-zinc-800",children:ye})]})}s.__docgenInfo={description:"",methods:[],displayName:"CharacterCard",props:{name:{required:!0,tsType:{name:"string"},description:"Character name"},imageUrl:{required:!1,tsType:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}]},description:"Character image URL"},summary:{required:!1,tsType:{name:"string"},description:"Character summary/description"},tags:{required:!0,tsType:{name:"Array",elements:[{name:"string"}],raw:"string[]"},description:`Character tags.
...
}`,...(we=(ve=a.parameters)==null?void 0:ve.docs)==null?void 0:we.source}}};var je,Le,ze;C.parameters={...C.parameters,docs:{...(je=C.parameters)==null?void 0:je.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    badges: [{
      label: 'CHARACTER',
...
}`,...(ze=(Le=C.parameters)==null?void 0:Le.docs)==null?void 0:ze.source}}};var Se,Ee,De;b.parameters={...b.parameters,docs:{...(Se=b.parameters)==null?void 0:Se.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    badges: [{
      label: 'CHARACTER',
...
}`,...(De=(Ee=b.parameters)==null?void 0:Ee.docs)==null?void 0:De.source}}};var Me,Pe,Ne;k.parameters={...k.parameters,docs:{...(Me=k.parameters)==null?void 0:Me.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    badges: [{
      label: 'CHARACTER',
...
}`,...(Ne=(Pe=k.parameters)==null?void 0:Pe.docs)==null?void 0:Ne.source}}};var Te,Re,Ue;A.parameters={...A.parameters,docs:{...(Te=A.parameters)==null?void 0:Te.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    badges: [{
      label: 'CHARACTER',
...
}`,...(Ue=(Re=A.parameters)==null?void 0:Re.docs)==null?void 0:Ue.source}}};var Be,Ie,We;v.parameters={...v.parameters,docs:{...(Be=v.parameters)==null?void 0:Be.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    badges: [{
      label: 'CHARACTER',
...
}`,...(We=(Ie=v.parameters)==null?void 0:Ie.docs)==null?void 0:We.source}}};var _e,Fe,Ge;w.parameters={...w.parameters,docs:{...(_e=w.parameters)==null?void 0:_e.docs,source:{originalSource:`{
  args: {
...
}`,...(Ge=(Fe=w.parameters)==null?void 0:Fe.docs)==null?void 0:Ge.source}}};var He,qe,Ye;j.parameters={...j.parameters,docs:{...(He=j.parameters)==null?void 0:He.docs,source:{originalSource:`{
  args: {
...
}`,...(Ye=(qe=j.parameters)==null?void 0:qe.docs)==null?void 0:Ye.source}}};var Je,Ve,Ke;L.parameters={...L.parameters,docs:{...(Je=L.parameters)==null?void 0:Je.docs,source:{originalSource:`{
  args: {
    name: 'Alice Wonderland',
...
}`,...(Ke=(Ve=L.parameters)==null?void 0:Ve.docs)==null?void 0:Ke.source}}};var $e,Qe,Oe;z.parameters={...z.parameters,docs:{...($e=z.parameters)==null?void 0:$e.docs,source:{originalSource:`{
  args: {
...
}`,...(Oe=(Qe=z.parameters)==null?void 0:Qe.docs)==null?void 0:Oe.source}}};var Ze,Xe,ea;S.parameters={...S.parameters,docs:{...(Ze=S.parameters)==null?void 0:Ze.docs,source:{originalSource:`{
  args: {
...
}`,...(ea=(Xe=S.parameters)==null?void 0:Xe.docs)==null?void 0:ea.source}}};var aa,ta,ra;E.parameters={...E.parameters,docs:{...(aa=E.parameters)==null?void 0:aa.docs,source:{originalSource:`{
  args: {
...
}`,...(ra=(ta=E.parameters)==null?void 0:ta.docs)==null?void 0:ra.source}}};var sa,oa,na;D.parameters={...D.parameters,docs:{...(sa=D.parameters)==null?void 0:sa.docs,source:{originalSource:`{
  args: {
...
}`,...(na=(oa=D.parameters)==null?void 0:oa.docs)==null?void 0:na.source}}};var ia,la,ca;M.parameters={...M.parameters,docs:{...(ia=M.parameters)==null?void 0:ia.docs,source:{originalSource:`{
  args: {
...
}`,...(ca=(la=M.parameters)==null?void 0:la.docs)==null?void 0:ca.source}}};var da,ua,ma;P.parameters={...P.parameters,docs:{...(da=P.parameters)==null?void 0:da.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    isDisabled: true
  }
}`,...(ma=(ua=P.parameters)==null?void 0:ua.docs)==null?void 0:ma.source}}};var pa,ga,ha;N.parameters={...N.parameters,docs:{...(pa=N.parameters)==null?void 0:pa.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    actions: [{
      icon: Edit,
...
}`,...(ha=(ga=N.parameters)==null?void 0:ga.docs)==null?void 0:ha.source}}};var xa,ya,fa;T.parameters={...T.parameters,docs:{...(xa=T.parameters)==null?void 0:xa.docs,source:{originalSource:`{
  args: {
    ...Default.args
  },
  decorators: [Story => <div style={{
...
}`,...(fa=(ya=T.parameters)==null?void 0:ya.docs)==null?void 0:fa.source}}};var Ca,ba,ka;R.parameters={...R.parameters,docs:{...(Ca=R.parameters)==null?void 0:Ca.docs,source:{originalSource:`{
  args: {
...
}`,...(ka=(ba=R.parameters)==null?void 0:ba.docs)==null?void 0:ka.source}}};var Aa,va,wa;U.parameters={...U.parameters,docs:{...(Aa=U.parameters)==null?void 0:Aa.docs,source:{originalSource:`{
  args: {
...
}`,...(wa=(va=U.parameters)==null?void 0:va.docs)==null?void 0:wa.source}}};var ja,La,za;B.parameters={...B.parameters,docs:{...(ja=B.parameters)==null?void 0:ja.docs,source:{originalSource:`{
  args: {
...
}`,...(za=(La=B.parameters)==null?void 0:La.docs)==null?void 0:za.source}}};var Sa,Ea,Da;I.parameters={...I.parameters,docs:{...(Sa=I.parameters)==null?void 0:Sa.docs,source:{originalSource:`{
  args: {
    ...Default.args
  },
  decorators: [Story => <div style={{
...
}`,...(Da=(Ea=I.parameters)==null?void 0:Ea.docs)==null?void 0:Da.source}}};var Ma,Pa,Na;W.parameters={...W.parameters,docs:{...(Ma=W.parameters)==null?void 0:Ma.docs,source:{originalSource:`{
  args: {
    ...Default.args
  },
  decorators: [Story => <div style={{
...
}`,...(Na=(Pa=W.parameters)==null?void 0:Pa.docs)==null?void 0:Na.source}}};var Ta,Ra,Ua;_.parameters={..._.parameters,docs:{...(Ta=_.parameters)==null?void 0:Ta.docs,source:{originalSource:`{
  args: {
    ...Default.args
  },
  decorators: [Story => <div style={{
...
}`,...(Ua=(Ra=_.parameters)==null?void 0:Ra.docs)==null?void 0:Ua.source}}};var Ba,Ia,Wa;F.parameters={...F.parameters,docs:{...(Ba=F.parameters)==null?void 0:Ba.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    likeButton: {
      isLiked: false,
...
}`,...(Wa=(Ia=F.parameters)==null?void 0:Ia.docs)==null?void 0:Wa.source}}};var _a,Fa,Ga;G.parameters={...G.parameters,docs:{...(_a=G.parameters)==null?void 0:_a.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    likeButton: {
      isLiked: true,
...
}`,...(Ga=(Fa=G.parameters)==null?void 0:Fa.docs)==null?void 0:Ga.source}}};var Ha,qa,Ya;H.parameters={...H.parameters,docs:{...(Ha=H.parameters)==null?void 0:Ha.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    likeCount: 1234
  }
}`,...(Ya=(qa=H.parameters)==null?void 0:qa.docs)==null?void 0:Ya.source}}};var Ja,Va,Ka;q.parameters={...q.parameters,docs:{...(Ja=q.parameters)==null?void 0:Ja.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    downloadCount: 5678
  }
}`,...(Ka=(Va=q.parameters)==null?void 0:Va.docs)==null?void 0:Ka.source}}};var $a,Qa,Oa;Y.parameters={...Y.parameters,docs:{...($a=Y.parameters)==null?void 0:$a.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    likeCount: 1234,
    downloadCount: 5678
  }
}`,...(Oa=(Qa=Y.parameters)==null?void 0:Qa.docs)==null?void 0:Oa.source}}};var Za,Xa,et;J.parameters={...J.parameters,docs:{...(Za=J.parameters)==null?void 0:Za.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    likeButton: {
      isLiked: false,
...
}`,...(et=(Xa=J.parameters)==null?void 0:Xa.docs)==null?void 0:et.source}}};var at,tt,rt;V.parameters={...V.parameters,docs:{...(at=V.parameters)==null?void 0:at.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    likeButton: {
      isLiked: true,
...
}`,...(rt=(tt=V.parameters)==null?void 0:tt.docs)==null?void 0:rt.source}}};var st,ot,nt;K.parameters={...K.parameters,docs:{...(st=K.parameters)==null?void 0:st.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    likeButton: {
      isLiked: false,
...
}`,...(nt=(ot=K.parameters)==null?void 0:ot.docs)==null?void 0:nt.source}}};var it,lt,ct;$.parameters={...$.parameters,docs:{...(it=$.parameters)==null?void 0:it.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    likeButton: {
      isLiked: true,
...
}`,...(ct=(lt=$.parameters)==null?void 0:lt.docs)==null?void 0:ct.source}}};var dt,ut,mt;Q.parameters={...Q.parameters,docs:{...(dt=Q.parameters)==null?void 0:dt.docs,source:{originalSource:`{
  args: {
    name: 'Alice Wonderland',
    imageUrl: SAMPLE_IMAGE,
    summary: 'A curious young girl who falls down a rabbit hole into a fantasy world populated by peculiar creatures.',
...
}`,...(mt=(ut=Q.parameters)==null?void 0:ut.docs)==null?void 0:mt.source}}};var pt,gt,ht;O.parameters={...O.parameters,docs:{...(pt=O.parameters)==null?void 0:pt.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    footerActions: <>
...
}`,...(ft=(yt=Z.parameters)==null?void 0:yt.docs)==null?void 0:ft.source}}};var Ct,bt,kt;X.parameters={...X.parameters,docs:{...(Ct=X.parameters)==null?void 0:Ct.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    badges: [{
      label: 'AI',
...
}`,...(kt=(bt=X.parameters)==null?void 0:bt.docs)==null?void 0:kt.source}}};var At,vt,wt;ee.parameters={...ee.parameters,docs:{...(At=ee.parameters)==null?void 0:At.docs,source:{originalSource:`{
  args: {
...
}`,...(wt=(vt=ee.parameters)==null?void 0:vt.docs)==null?void 0:wt.source}}};var jt,Lt,zt;ae.parameters={...ae.parameters,docs:{...(jt=ae.parameters)==null?void 0:jt.docs,source:{originalSource:`{
  args: {
    ...Default.args
  },
  decorators: [Story => <div style={{
...
}`,...(zt=(Lt=ae.parameters)==null?void 0:Lt.docs)==null?void 0:zt.source}}};var St,Et,Dt;te.parameters={...te.parameters,docs:{...(St=te.parameters)==null?void 0:St.docs,source:{originalSource:`{
  args: {
    ...Default.args
  },
  decorators: [Story => <div style={{
...
}`,...(Dt=(Et=te.parameters)==null?void 0:Et.docs)==null?void 0:Dt.source}}};var Mt,Pt,Nt;re.parameters={...re.parameters,docs:{...(Mt=re.parameters)==null?void 0:Mt.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    badges: [{
      label: 'CHARACTER',
...
}`,...(Nt=(Pt=re.parameters)==null?void 0:Pt.docs)==null?void 0:Nt.source}}};const Ar=["Default","WithBadges","WithMultipleBadges","WithAllBadgeVariants","WithBadgesLeftAndRight","WithMultipleBadgesEachSide","WithoutImage","WithPlaceholder","ImageError","ManyTags","ResponsiveTags","NarrowCardWidth","NoTags","LongName","Disabled","WithActions","GridLayout","CustomMetadata","MetadataWithIcons","FullyCustomMetadata","AllStates","Skeleton","SkeletonGrid","WithLikeButton","WithLikeButtonLiked","WithLikeCount","WithDownloadCount","WithPopularityStats","WithLikeButtonAndStats","WithLikeButtonLikedAndStats","WithLikeButtonAndActions","HighPopularityCounts","FullFeatured","WithFooterActions","WithFooterActionsSelectedPlayer","WithFooterActionsSelectedAI","WithFooterActionsCompact","GridLayoutWithFooterActions","GridLayoutWithPopularity","LikeButtonHidesRightBadge"];export{I as AllStates,R as CustomMetadata,a as Default,P as Disabled,Q as FullFeatured,B as FullyCustomMetadata,T as GridLayout,ae as GridLayoutWithFooterActions,te as GridLayoutWithPopularity,$ as HighPopularityCounts,L as ImageError,re as LikeButtonHidesRightBadge,M as LongName,z as ManyTags,U as MetadataWithIcons,E as NarrowCardWidth,D as NoTags,S as ResponsiveTags,W as Skeleton,_ as SkeletonGrid,N as WithActions,k as WithAllBadgeVariants,C as WithBadges,A as WithBadgesLeftAndRight,q as WithDownloadCount,O as WithFooterActions,ee as WithFooterActionsCompact,X as WithFooterActionsSelectedAI,Z as WithFooterActionsSelectedPlayer,F as WithLikeButton,K as WithLikeButtonAndActions,J as WithLikeButtonAndStats,G as WithLikeButtonLiked,V as WithLikeButtonLikedAndStats,H as WithLikeCount,b as WithMultipleBadges,v as WithMultipleBadgesEachSide,j as WithPlaceholder,Y as WithPopularityStats,w as WithoutImage,Ar as __namedExportsOrder,kr as default};
