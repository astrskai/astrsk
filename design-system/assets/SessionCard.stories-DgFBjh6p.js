import{r as he,j as e}from"./iframe-DpOJYBjt.js";import{c as d}from"./utils-CF6QUdYH.js";import{u as ft,B as nt,C as At,a as Ct,b as Ue,c as bt,d as kt,e as yt,S as Ce,f as it,D as ot,T as lt,L as r,g as ct}from"./useImageRenderer-xETPfDL6.js";import{S as g}from"./Skeleton-BeyH33Fj.js";import{L as l}from"./lock-yV83BfWz.js";import{U as x}from"./user-5Wq7UKTk.js";import{S as xe,U as jt}from"./users-Bqk6yVP5.js";import"./preload-helper-CwRszBsw.js";import"./createLucideIcon-gHw0okDa.js";function Lt({name:s,avatarUrl:c,loading:h="lazy"}){const[Se,A]=he.useState(!1);he.useEffect(()=>{A(!1)},[c]);const C=c&&!Se;return e.jsx("div",{className:"flex h-8 w-8 items-center justify-center overflow-hidden rounded-full border-2 border-zinc-900 bg-zinc-700",title:s,children:C?e.jsx("img",{src:c,alt:s,className:"h-full w-full object-cover",loading:h,onError:()=>A(!0)}):e.jsx("span",{className:"text-[10px] text-zinc-400",children:s.charAt(0).toUpperCase()||"?"})})}function Ae(){return e.jsx("div",{className:"h-8 w-8 animate-pulse rounded-full border-2 border-zinc-900 bg-zinc-700"})}function Et({className:s}){return e.jsx("svg",{className:s,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round",children:e.jsx("path",{d:"M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"})})}const dt=kt,ve=yt;function o({title:s,imageUrl:c,messageCount:h,actions:Se=[],className:A,isDisabled:C=!1,onClick:be,characterAvatars:b=[],areCharactersLoading:ke=!1,badges:k=[],renderMetadata:ye,tags:u=[],summary:je,likeButton:y,likeCount:Le,downloadCount:Ee,imageSizes:ut,loading:gt="lazy",priority:we=!1,renderImage:pt,classNames:t}){const[ze,Me]=he.useState(!1),ht=ft({renderImage:pt});he.useEffect(()=>{Me(!1)},[c]);const vt=c&&!ze,xt=c&&ze,St=()=>c?ht({src:c,alt:s,className:"absolute inset-0 h-full w-full object-cover opacity-80 transition-all duration-700 group-hover:scale-105 group-hover:opacity-90",sizes:ut,loading:we?void 0:gt,onError:()=>Me(!0),fill:!0,priority:we}):null;return e.jsxs(nt,{className:d("min-h-[320px] w-full bg-zinc-900 border-zinc-800 ring-1 ring-zinc-800/50 hover:border-zinc-600",!C&&be&&"hover:ring-zinc-700",A),isDisabled:C,onClick:be,children:[e.jsxs("div",{className:"relative h-48 overflow-hidden bg-zinc-800",children:[vt?e.jsxs(e.Fragment,{children:[St(),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-zinc-900 via-zinc-900/40 to-transparent"})]}):xt?e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"absolute inset-0 flex items-center justify-center",children:e.jsx("span",{className:"text-6xl font-bold text-zinc-500",children:s.charAt(0).toUpperCase()||"?"})}),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-zinc-900 to-transparent"})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"absolute inset-0 bg-zinc-800",children:e.jsx("div",{className:"absolute inset-0 opacity-20",style:{backgroundImage:"radial-gradient(#4f46e5 1px, transparent 1px)",backgroundSize:"16px 16px"}})}),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-zinc-900 to-transparent"})]}),y&&e.jsx("div",{className:"absolute top-2 right-2 z-20",children:e.jsx(At,{...y})}),e.jsx(Ct,{actions:Se,className:y?"top-12":void 0}),k.some(n=>(n.position??"left")==="left")&&e.jsx("div",{className:"absolute top-3 left-3 z-10 max-w-[45%]",children:e.jsx(Ue,{badges:k,position:"left"})}),!y&&k.some(n=>n.position==="right")&&e.jsx("div",{className:"absolute top-3 right-3 z-10 max-w-[45%]",children:e.jsx(Ue,{badges:k,position:"right"})}),e.jsx("div",{className:"absolute bottom-0 left-0 w-full p-5",children:e.jsx("h2",{className:d("line-clamp-2 text-xl md:text-2xl leading-tight font-bold text-ellipsis text-white",t==null?void 0:t.title),children:s})})]}),e.jsx("div",{className:"flex flex-grow flex-col justify-between p-5",children:e.jsxs("div",{className:"space-y-2 md:space-y-3",children:[u.length>0&&e.jsxs("div",{className:d("flex flex-wrap gap-2",t==null?void 0:t.tagsContainer),children:[u.slice(0,2).map((n,fe)=>e.jsx("span",{className:d("max-w-[35%] @[240px]:max-w-[26%] truncate rounded border border-zinc-700/50 bg-zinc-800/80 px-1.5 py-0.5 text-[10px] text-zinc-300",t==null?void 0:t.tag),children:n},`${n}-${fe}`)),u[2]&&e.jsx("span",{className:d("hidden @[240px]:inline! max-w-[26%] truncate rounded border border-zinc-700/50 bg-zinc-800/80 px-1.5 py-0.5 text-[10px] text-zinc-300",t==null?void 0:t.tag),children:u[2]}),u.length>2&&e.jsxs("span",{className:d("@[240px]:hidden! shrink-0 rounded border border-zinc-700/50 bg-zinc-800/80 px-1.5 py-0.5 text-[10px] text-zinc-300",t==null?void 0:t.tag),children:["+",u.length-2]}),u.length>3&&e.jsxs("span",{className:d("hidden @[240px]:inline! shrink-0 rounded border border-zinc-700/50 bg-zinc-800/80 px-1.5 py-0.5 text-[10px] text-zinc-300",t==null?void 0:t.tag),children:["+",u.length-3]})]}),je&&e.jsx("p",{className:d("line-clamp-2 text-xs leading-relaxed break-all text-ellipsis text-zinc-400",t==null?void 0:t.summary),children:je}),(Le!==void 0||Ee!==void 0)&&e.jsx(bt,{likeCount:Le,downloadCount:Ee}),ye?ye():h!==void 0&&e.jsx("div",{className:"flex items-center justify-between text-sm",children:h===0?e.jsx("span",{className:"text-zinc-400",children:"New session"}):e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(Et,{className:"h-4 w-4 text-zinc-400"}),e.jsx("span",{className:"font-semibold text-zinc-300",children:h.toLocaleString()}),e.jsx("span",{className:"text-zinc-400",children:h===1?"Message":"Messages"})]})}),(ke||b.length>0)&&e.jsx("div",{className:"border-t border-zinc-800 pt-3",children:ke?e.jsxs("div",{className:"flex -space-x-2",children:[e.jsx(Ae,{}),e.jsx(Ae,{}),e.jsx(Ae,{})]}):e.jsxs("div",{className:"flex -space-x-2",children:[b.slice(0,3).map((n,fe)=>e.jsx(Lt,{name:n.name,avatarUrl:n.avatarUrl,loading:n.loading??"lazy"},`${n.name}-${fe}`)),b.length>3&&e.jsxs("div",{className:"flex h-8 w-8 items-center justify-center rounded-full border-2 border-zinc-900 bg-zinc-800 text-[10px] text-zinc-400",children:["+",b.length-3]})]})})]})})]})}o.__docgenInfo={description:"",methods:[],displayName:"SessionCard",props:{title:{required:!0,tsType:{name:"string"},description:"Session title"},imageUrl:{required:!1,tsType:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}]},description:"Cover image URL"},messageCount:{required:!1,tsType:{name:"number"},description:"Number of messages in the session (used in default metadata)"},actions:{required:!1,tsType:{name:"Array",elements:[{name:"CardAction"}],raw:"CardAction[]"},description:"Action buttons displayed on the card",defaultValue:{value:"[]",computed:!1}},className:{required:!1,tsType:{name:"string"},description:"Additional CSS classes"},isDisabled:{required:!1,tsType:{name:"boolean"},description:"Whether the card is disabled",defaultValue:{value:"false",computed:!1}},onClick:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"Click handler for the card"},characterAvatars:{required:!1,tsType:{name:"Array",elements:[{name:"CharacterAvatar"}],raw:"CharacterAvatar[]"},description:"Character avatars to display",defaultValue:{value:"[]",computed:!1}},areCharactersLoading:{required:!1,tsType:{name:"boolean"},description:"Whether characters are loading",defaultValue:{value:"false",computed:!1}},badges:{required:!1,tsType:{name:"Array",elements:[{name:"CardBadge"}],raw:"CardBadge[]"},description:"Badges to display on the card (e.g., type indicator, private, owner).",defaultValue:{value:"[]",computed:!1}},renderMetadata:{required:!1,tsType:{name:"signature",type:"function",raw:"() => React.ReactNode",signature:{arguments:[],return:{name:"ReactReactNode",raw:"React.ReactNode"}}},description:`Custom render function for the metadata section.
...
/>
\`\`\``}}};function v({className:s}){return e.jsxs(nt,{className:d("min-h-[320px] w-full bg-zinc-900 border-zinc-800 ring-1 ring-zinc-800/50",s),isDisabled:!0,children:[e.jsxs("div",{className:"relative h-48 overflow-hidden bg-zinc-800",children:[e.jsx(g,{className:"absolute inset-0 h-full w-full",variant:"default"}),e.jsxs("div",{className:"absolute bottom-0 left-0 w-full p-5",children:[e.jsx(g,{className:"mb-2 h-7 w-3/4"}),e.jsx(g,{className:"h-7 w-1/2"})]})]}),e.jsx("div",{className:"flex flex-grow flex-col justify-between p-5",children:e.jsxs("div",{className:"space-y-3",children:[e.jsx("div",{className:"flex items-center justify-between border-b border-zinc-800 pb-2",children:e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(g,{className:"size-4",variant:"circular"}),e.jsx(g,{className:"h-4 w-20"})]})}),e.jsxs("div",{className:"flex -space-x-2 pt-1",children:[e.jsx(g,{className:"size-8 border-2 border-zinc-900",variant:"circular"}),e.jsx(g,{className:"size-8 border-2 border-zinc-900",variant:"circular"}),e.jsx(g,{className:"size-8 border-2 border-zinc-900",variant:"circular"})]})]})})]})}v.displayName="SessionCardSkeleton";v.__docgenInfo={description:`SessionCardSkeleton Component
...
}`,...(fa=(Sa=_.parameters)==null?void 0:Sa.docs)==null?void 0:fa.source}}};var Aa,Ca,ba;R.parameters={...R.parameters,docs:{...(Aa=R.parameters)==null?void 0:Aa.docs,source:{originalSource:`{
  args: {
...
}`,...(ba=(Ca=R.parameters)==null?void 0:Ca.docs)==null?void 0:ba.source}}};var ka,ya,ja;I.parameters={...I.parameters,docs:{...(ka=I.parameters)==null?void 0:ka.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    title: 'Group Session',
    characterAvatars: [{
...
}`,...(fs=(Ss=ae.parameters)==null?void 0:Ss.docs)==null?void 0:fs.source}}};var As,Cs,bs;se.parameters={...se.parameters,docs:{...(As=se.parameters)==null?void 0:As.docs,source:{originalSource:`{
  args: {
    ...Default.args
  },
  decorators: [Story => <div style={{
...
}`,...(bs=(Cs=se.parameters)==null?void 0:Cs.docs)==null?void 0:bs.source}}};var ks,ys,js;te.parameters={...te.parameters,docs:{...(ks=te.parameters)==null?void 0:ks.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    likeButton: {
      isLiked: false,
