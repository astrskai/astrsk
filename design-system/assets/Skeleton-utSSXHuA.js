import{j as o}from"./iframe-Bv57Sfj-.js";import{c as s}from"./utils-DuMXYCiK.js";function r({className:t,width:e,height:n,variant:a="default",style:l,...i}){return o.jsx("div",{className:s("animate-pulse bg-zinc-700",a==="default"&&"rounded",a==="circular"&&"rounded-full",a==="rounded"&&"rounded-xl",t),style:{...l,...e!==void 0&&{width:typeof e=="number"?`${e}px`:e},...n!==void 0&&{height:typeof n=="number"?`${n}px`:n}},"aria-hidden":"true",...i})}r.displayName="Skeleton";r.__docgenInfo={description:`Skeleton Component
