import{r as he,j as e}from"./iframe-DnVlusoH.js";import{c as g}from"./utils-CF6QUdYH.js";import{u as ft,B as rt,C as At,a as Ct,b as Me,c as kt,d as bt,e as yt,S as Ce,f as nt,D as it,T as ot,L as r,g as lt}from"./useImageRenderer-D2k2AGtj.js";import{S as m}from"./Skeleton-IXr2085K.js";import{L as l}from"./lock-Cbx0FWCW.js";import{U as v}from"./user-BUWzg_yR.js";import{S as xe,U as jt}from"./users-BkH4DWUr.js";import"./preload-helper-CwRszBsw.js";import"./createLucideIcon-BU1d_TG2.js";function Lt({name:s,avatarUrl:c,loading:p="lazy"}){const[Se,f]=he.useState(!1);he.useEffect(()=>{f(!1)},[c]);const A=c&&!Se;return e.jsx("div",{className:"flex h-8 w-8 items-center justify-center overflow-hidden rounded-full border-2 border-zinc-900 bg-zinc-700",title:s,children:A?e.jsx("img",{src:c,alt:s,className:"h-full w-full object-cover",loading:p,onError:()=>f(!0)}):e.jsx("span",{className:"text-[10px] text-zinc-400",children:s.charAt(0).toUpperCase()||"?"})})}function Ae(){return e.jsx("div",{className:"h-8 w-8 animate-pulse rounded-full border-2 border-zinc-900 bg-zinc-700"})}function Et({className:s}){return e.jsx("svg",{className:s,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round",children:e.jsx("path",{d:"M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"})})}const ct=bt,ve=yt;function o({title:s,imageUrl:c,messageCount:p,actions:Se=[],className:f,isDisabled:A=!1,onClick:ke,characterAvatars:C=[],areCharactersLoading:be=!1,badges:k=[],renderMetadata:ye,tags:b=[],summary:je,likeButton:y,likeCount:Le,downloadCount:Ee,imageSizes:mt,loading:ut="lazy",priority:gt=!1,renderImage:pt,classNames:t}){const[we,ze]=he.useState(!1),ht=ft({renderImage:pt});he.useEffect(()=>{ze(!1)},[c]);const vt=c&&!we,xt=c&&we,St=()=>c?ht({src:c,alt:s,className:"absolute inset-0 h-full w-full object-cover opacity-80 transition-all duration-700 group-hover:scale-105 group-hover:opacity-90",sizes:mt,loading:ut,onError:()=>ze(!0),fill:!0,priority:gt}):null;return e.jsxs(rt,{className:g("min-h-[320px] w-full border-zinc-800 ring-1 ring-zinc-800/50",!A&&ke&&"hover:ring-zinc-700",f),isDisabled:A,onClick:ke,children:[e.jsxs("div",{className:"relative h-48 overflow-hidden bg-zinc-800",children:[vt?e.jsxs(e.Fragment,{children:[St(),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-zinc-900 via-zinc-900/40 to-transparent"})]}):xt?e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"absolute inset-0 flex items-center justify-center",children:e.jsx("span",{className:"text-6xl font-bold text-zinc-500",children:s.charAt(0).toUpperCase()||"?"})}),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-zinc-900 to-transparent"})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"absolute inset-0 bg-zinc-800",children:e.jsx("div",{className:"absolute inset-0 opacity-20",style:{backgroundImage:"radial-gradient(#4f46e5 1px, transparent 1px)",backgroundSize:"16px 16px"}})}),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-zinc-900 to-transparent"})]}),y&&e.jsx("div",{className:"absolute top-2 right-2 z-20",children:e.jsx(At,{...y})}),e.jsx(Ct,{actions:Se,className:y?"top-12":void 0}),k.some(n=>(n.position??"left")==="left")&&e.jsx("div",{className:"absolute top-3 left-3 z-10 max-w-[45%]",children:e.jsx(Me,{badges:k,position:"left"})}),!y&&k.some(n=>n.position==="right")&&e.jsx("div",{className:"absolute top-3 right-3 z-10 max-w-[45%]",children:e.jsx(Me,{badges:k,position:"right"})}),e.jsx("div",{className:"absolute bottom-0 left-0 w-full p-5",children:e.jsx("h2",{className:g("line-clamp-2 text-xl md:text-2xl leading-tight font-bold text-ellipsis text-white",t==null?void 0:t.title),children:s})})]}),e.jsx("div",{className:"flex flex-grow flex-col justify-between p-5",children:e.jsxs("div",{className:"space-y-2 md:space-y-3",children:[b.length>0&&e.jsxs("div",{className:g("flex flex-wrap gap-2",t==null?void 0:t.tagsContainer),children:[b.slice(0,3).map((n,fe)=>e.jsx("span",{className:g("rounded border border-zinc-700/50 bg-zinc-800/80 px-1.5 py-0.5 text-[10px] text-zinc-300",t==null?void 0:t.tag),children:n},`${n}-${fe}`)),b.length>3&&e.jsxs("span",{className:g("rounded border border-zinc-700/50 bg-zinc-800/80 px-1.5 py-0.5 text-[10px] text-zinc-300",t==null?void 0:t.tag),children:["+",b.length-3]})]}),je&&e.jsx("p",{className:g("line-clamp-2 text-xs leading-relaxed break-all text-ellipsis text-zinc-400",t==null?void 0:t.summary),children:je}),(Le!==void 0||Ee!==void 0)&&e.jsx(kt,{likeCount:Le,downloadCount:Ee}),ye?ye():p!==void 0&&e.jsx("div",{className:"flex items-center justify-between text-sm",children:p===0?e.jsx("span",{className:"text-zinc-400",children:"New session"}):e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(Et,{className:"h-4 w-4 text-zinc-400"}),e.jsx("span",{className:"font-semibold text-zinc-300",children:p.toLocaleString()}),e.jsx("span",{className:"text-zinc-400",children:p===1?"Message":"Messages"})]})}),(be||C.length>0)&&e.jsx("div",{className:"border-t border-zinc-800 pt-3",children:be?e.jsxs("div",{className:"flex -space-x-2",children:[e.jsx(Ae,{}),e.jsx(Ae,{}),e.jsx(Ae,{})]}):e.jsxs("div",{className:"flex -space-x-2",children:[C.slice(0,3).map((n,fe)=>e.jsx(Lt,{name:n.name,avatarUrl:n.avatarUrl,loading:n.loading??"lazy"},`${n.name}-${fe}`)),C.length>3&&e.jsxs("div",{className:"flex h-8 w-8 items-center justify-center rounded-full border-2 border-zinc-900 bg-zinc-800 text-[10px] text-zinc-400",children:["+",C.length-3]})]})})]})})]})}o.__docgenInfo={description:"",methods:[],displayName:"SessionCard",props:{title:{required:!0,tsType:{name:"string"},description:"Session title"},imageUrl:{required:!1,tsType:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}]},description:"Cover image URL"},messageCount:{required:!1,tsType:{name:"number"},description:"Number of messages in the session (used in default metadata)"},actions:{required:!1,tsType:{name:"Array",elements:[{name:"CardAction"}],raw:"CardAction[]"},description:"Action buttons displayed on the card",defaultValue:{value:"[]",computed:!1}},className:{required:!1,tsType:{name:"string"},description:"Additional CSS classes"},isDisabled:{required:!1,tsType:{name:"boolean"},description:"Whether the card is disabled",defaultValue:{value:"false",computed:!1}},onClick:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"Click handler for the card"},characterAvatars:{required:!1,tsType:{name:"Array",elements:[{name:"CharacterAvatar"}],raw:"CharacterAvatar[]"},description:"Character avatars to display",defaultValue:{value:"[]",computed:!1}},areCharactersLoading:{required:!1,tsType:{name:"boolean"},description:"Whether characters are loading",defaultValue:{value:"false",computed:!1}},badges:{required:!1,tsType:{name:"Array",elements:[{name:"CardBadge"}],raw:"CardBadge[]"},description:"Badges to display on the card (e.g., type indicator, private, owner).",defaultValue:{value:"[]",computed:!1}},renderMetadata:{required:!1,tsType:{name:"signature",type:"function",raw:"() => React.ReactNode",signature:{arguments:[],return:{name:"ReactReactNode",raw:"React.ReactNode"}}},description:`Custom render function for the metadata section.
...
}`,...(Be=(Ne=a.parameters)==null?void 0:Ne.docs)==null?void 0:Be.source}}};var Te,De,Pe;j.parameters={...j.parameters,docs:{...(Te=j.parameters)==null?void 0:Te.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    badges: [{
      label: 'SESSION',
...
}`,...(Pe=(De=j.parameters)==null?void 0:De.docs)==null?void 0:Pe.source}}};var _e,Re,Ie;L.parameters={...L.parameters,docs:{...(_e=L.parameters)==null?void 0:_e.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    badges: [{
      label: 'SESSION',
...
}`,...(Ie=(Re=L.parameters)==null?void 0:Re.docs)==null?void 0:Ie.source}}};var We,Ve,Oe;E.parameters={...E.parameters,docs:{...(We=E.parameters)==null?void 0:We.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    badges: [{
      label: 'SESSION',
...
}`,...(Oe=(Ve=E.parameters)==null?void 0:Ve.docs)==null?void 0:Oe.source}}};var Fe,qe,Ge;w.parameters={...w.parameters,docs:{...(Fe=w.parameters)==null?void 0:Fe.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    badges: [{
      label: 'SESSION',
...
}`,...(Ge=(qe=w.parameters)==null?void 0:qe.docs)==null?void 0:Ge.source}}};var He,$e,Je;z.parameters={...z.parameters,docs:{...(He=z.parameters)==null?void 0:He.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    badges: [{
      label: 'SESSION',
...
}`,...(Je=($e=z.parameters)==null?void 0:$e.docs)==null?void 0:Je.source}}};var Qe,Ke,Xe;M.parameters={...M.parameters,docs:{...(Qe=M.parameters)==null?void 0:Qe.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    badges: [{
      label: 'SESSION',
...
}`,...(Xe=(Ke=M.parameters)==null?void 0:Ke.docs)==null?void 0:Xe.source}}};var Ye,Ze,ea;U.parameters={...U.parameters,docs:{...(Ye=U.parameters)==null?void 0:Ye.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    badges: [{
      label: 'SESSION',
...
}`,...(ea=(Ze=U.parameters)==null?void 0:Ze.docs)==null?void 0:ea.source}}};var aa,sa,ta;N.parameters={...N.parameters,docs:{...(aa=N.parameters)==null?void 0:aa.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    badges: [{
      label: 'SESSION',
...
}`,...(ta=(sa=N.parameters)==null?void 0:sa.docs)==null?void 0:ta.source}}};var ra,na,ia;B.parameters={...B.parameters,docs:{...(ra=B.parameters)==null?void 0:ra.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    badges: [{
...
}`,...(ia=(na=B.parameters)==null?void 0:na.docs)==null?void 0:ia.source}}};var oa,la,ca;T.parameters={...T.parameters,docs:{...(oa=T.parameters)==null?void 0:oa.docs,source:{originalSource:`{
  args: {
    title: 'New Adventure',
...
}`,...(ca=(la=T.parameters)==null?void 0:la.docs)==null?void 0:ca.source}}};var da,ma,ua;D.parameters={...D.parameters,docs:{...(da=D.parameters)==null?void 0:da.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    title: 'Just Started',
    messageCount: 1
  }
}`,...(ua=(ma=D.parameters)==null?void 0:ma.docs)==null?void 0:ua.source}}};var ga,pa,ha;P.parameters={...P.parameters,docs:{...(ga=P.parameters)==null?void 0:ga.docs,source:{originalSource:`{
  args: {
...
}`,...(ha=(pa=P.parameters)==null?void 0:pa.docs)==null?void 0:ha.source}}};var va,xa,Sa;_.parameters={..._.parameters,docs:{...(va=_.parameters)==null?void 0:va.docs,source:{originalSource:`{
  args: {
...
}`,...(Sa=(xa=_.parameters)==null?void 0:xa.docs)==null?void 0:Sa.source}}};var fa,Aa,Ca;R.parameters={...R.parameters,docs:{...(fa=R.parameters)==null?void 0:fa.docs,source:{originalSource:`{
  args: {
...
}`,...(Ca=(Aa=R.parameters)==null?void 0:Aa.docs)==null?void 0:Ca.source}}};var ka,ba,ya;I.parameters={...I.parameters,docs:{...(ka=I.parameters)==null?void 0:ka.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    title: 'Group Session',
    characterAvatars: [{
...
}`,...(ya=(ba=I.parameters)==null?void 0:ba.docs)==null?void 0:ya.source}}};var ja,La,Ea;W.parameters={...W.parameters,docs:{...(ja=W.parameters)==null?void 0:ja.docs,source:{originalSource:`{
  args: {
    ...Default.args,
...
}`,...(Ea=(La=W.parameters)==null?void 0:La.docs)==null?void 0:Ea.source}}};var wa,za,Ma;V.parameters={...V.parameters,docs:{...(wa=V.parameters)==null?void 0:wa.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    isDisabled: true
  }
}`,...(Ma=(za=V.parameters)==null?void 0:za.docs)==null?void 0:Ma.source}}};var Ua,Na,Ba;O.parameters={...O.parameters,docs:{...(Ua=O.parameters)==null?void 0:Ua.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    title: 'The Exceptionally Long Session Title That Should Be Truncated After Two Lines'
  }
}`,...(Ba=(Na=O.parameters)==null?void 0:Na.docs)==null?void 0:Ba.source}}};var Ta,Da,Pa;F.parameters={...F.parameters,docs:{...(Ta=F.parameters)==null?void 0:Ta.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    actions: [{
      icon: Edit,
...
}`,...(Pa=(Da=F.parameters)==null?void 0:Da.docs)==null?void 0:Pa.source}}};var _a,Ra,Ia;q.parameters={...q.parameters,docs:{...(_a=q.parameters)==null?void 0:_a.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    title: 'Epic Campaign',
    messageCount: 12345
  }
}`,...(Ia=(Ra=q.parameters)==null?void 0:Ra.docs)==null?void 0:Ia.source}}};var Wa,Va,Oa;G.parameters={...G.parameters,docs:{...(Wa=G.parameters)==null?void 0:Wa.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    title: 'Fantasy Adventure',
    tags: ['Fantasy', 'Adventure', 'RPG']
  }
}`,...(Oa=(Va=G.parameters)==null?void 0:Va.docs)==null?void 0:Oa.source}}};var Fa,qa,Ga;H.parameters={...H.parameters,docs:{...(Fa=H.parameters)==null?void 0:Fa.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    title: 'Multi-Genre Session',
    tags: ['Fantasy', 'Sci-Fi', 'Horror', 'Mystery', 'Romance']
  }
}`,...(Ga=(qa=H.parameters)==null?void 0:qa.docs)==null?void 0:Ga.source}}};var Ha,$a,Ja;$.parameters={...$.parameters,docs:{...(Ha=$.parameters)==null?void 0:Ha.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    title: 'Quick Session',
    tags: ['Casual']
  }
}`,...(Ja=($a=$.parameters)==null?void 0:$a.docs)==null?void 0:Ja.source}}};var Qa,Ka,Xa;J.parameters={...J.parameters,docs:{...(Qa=J.parameters)==null?void 0:Qa.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    title: 'Epic Quest',
    summary: 'An immersive fantasy adventure where heroes embark on a dangerous journey to save the kingdom from ancient evil.'
  }
}`,...(Xa=(Ka=J.parameters)==null?void 0:Ka.docs)==null?void 0:Xa.source}}};var Ya,Za,es;Q.parameters={...Q.parameters,docs:{...(Ya=Q.parameters)==null?void 0:Ya.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    title: 'Mystery Manor',
...
}`,...(es=(Za=Q.parameters)==null?void 0:Za.docs)==null?void 0:es.source}}};var as,ss,ts;K.parameters={...K.parameters,docs:{...(as=K.parameters)==null?void 0:as.docs,source:{originalSource:`{
  args: {
    ...Default.args
  },
...
}`,...(ts=(ss=K.parameters)==null?void 0:ss.docs)==null?void 0:ts.source}}};var rs,ns,is;X.parameters={...X.parameters,docs:{...(rs=X.parameters)==null?void 0:rs.docs,source:{originalSource:`{
  args: {
...
}`,...(is=(ns=X.parameters)==null?void 0:ns.docs)==null?void 0:is.source}}};var os,ls,cs;Y.parameters={...Y.parameters,docs:{...(os=Y.parameters)==null?void 0:os.docs,source:{originalSource:`{
  args: {
...
}`,...(cs=(ls=Y.parameters)==null?void 0:ls.docs)==null?void 0:cs.source}}};var ds,ms,us;Z.parameters={...Z.parameters,docs:{...(ds=Z.parameters)==null?void 0:ds.docs,source:{originalSource:`{
  args: {
...
}`,...(us=(ms=Z.parameters)==null?void 0:ms.docs)==null?void 0:us.source}}};var gs,ps,hs;ee.parameters={...ee.parameters,docs:{...(gs=ee.parameters)==null?void 0:gs.docs,source:{originalSource:`{
  args: {
    ...Default.args
  },
  decorators: [Story => <div style={{
...
}`,...(hs=(ps=ee.parameters)==null?void 0:ps.docs)==null?void 0:hs.source}}};var vs,xs,Ss;ae.parameters={...ae.parameters,docs:{...(vs=ae.parameters)==null?void 0:vs.docs,source:{originalSource:`{
  args: {
    ...Default.args
  },
  decorators: [Story => <div style={{
...
}`,...(Ss=(xs=ae.parameters)==null?void 0:xs.docs)==null?void 0:Ss.source}}};var fs,As,Cs;se.parameters={...se.parameters,docs:{...(fs=se.parameters)==null?void 0:fs.docs,source:{originalSource:`{
  args: {
    ...Default.args
  },
  decorators: [Story => <div style={{
...
}`,...(Cs=(As=se.parameters)==null?void 0:As.docs)==null?void 0:Cs.source}}};var ks,bs,ys;te.parameters={...te.parameters,docs:{...(ks=te.parameters)==null?void 0:ks.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    likeButton: {
      isLiked: false,
...
}`,...(ys=(bs=te.parameters)==null?void 0:bs.docs)==null?void 0:ys.source}}};var js,Ls,Es;re.parameters={...re.parameters,docs:{...(js=re.parameters)==null?void 0:js.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    likeButton: {
      isLiked: true,
...
}`,...(Es=(Ls=re.parameters)==null?void 0:Ls.docs)==null?void 0:Es.source}}};var ws,zs,Ms;ne.parameters={...ne.parameters,docs:{...(ws=ne.parameters)==null?void 0:ws.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    likeCount: 1234
  }
}`,...(Ms=(zs=ne.parameters)==null?void 0:zs.docs)==null?void 0:Ms.source}}};var Us,Ns,Bs;ie.parameters={...ie.parameters,docs:{...(Us=ie.parameters)==null?void 0:Us.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    downloadCount: 5678
  }
}`,...(Bs=(Ns=ie.parameters)==null?void 0:Ns.docs)==null?void 0:Bs.source}}};var Ts,Ds,Ps;oe.parameters={...oe.parameters,docs:{...(Ts=oe.parameters)==null?void 0:Ts.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    likeCount: 1234,
    downloadCount: 5678
  }
}`,...(Ps=(Ds=oe.parameters)==null?void 0:Ds.docs)==null?void 0:Ps.source}}};var _s,Rs,Is;le.parameters={...le.parameters,docs:{...(_s=le.parameters)==null?void 0:_s.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    likeButton: {
      isLiked: false,
...
}`,...(Is=(Rs=le.parameters)==null?void 0:Rs.docs)==null?void 0:Is.source}}};var Ws,Vs,Os;ce.parameters={...ce.parameters,docs:{...(Ws=ce.parameters)==null?void 0:Ws.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    likeButton: {
      isLiked: true,
...
}`,...(Os=(Vs=ce.parameters)==null?void 0:Vs.docs)==null?void 0:Os.source}}};var Fs,qs,Gs;de.parameters={...de.parameters,docs:{...(Fs=de.parameters)==null?void 0:Fs.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    likeButton: {
      isLiked: false,
...
}`,...(Gs=(qs=de.parameters)==null?void 0:qs.docs)==null?void 0:Gs.source}}};var Hs,$s,Js;me.parameters={...me.parameters,docs:{...(Hs=me.parameters)==null?void 0:Hs.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    likeButton: {
      isLiked: true,
...
}`,...(Js=($s=me.parameters)==null?void 0:$s.docs)==null?void 0:Js.source}}};var Qs,Ks,Xs;ue.parameters={...ue.parameters,docs:{...(Qs=ue.parameters)==null?void 0:Qs.docs,source:{originalSource:`{
  args: {
...
}`,...(Xs=(Ks=ue.parameters)==null?void 0:Ks.docs)==null?void 0:Xs.source}}};var Ys,Zs,et;ge.parameters={...ge.parameters,docs:{...(Ys=ge.parameters)==null?void 0:Ys.docs,source:{originalSource:`{
  args: {
    ...Default.args
  },
  decorators: [Story => <div style={{
...
}`,...(et=(Zs=ge.parameters)==null?void 0:Zs.docs)==null?void 0:et.source}}};var at,st,tt;pe.parameters={...pe.parameters,docs:{...(at=pe.parameters)==null?void 0:at.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    badges: [{
      label: 'SESSION',
