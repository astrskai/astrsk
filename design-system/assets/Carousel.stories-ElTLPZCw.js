import{r as i,R as ce,j as e}from"./iframe-DIyqx50_.js";import{c as d}from"./utils-DuMXYCiK.js";import{C as s}from"./CharacterCard-CZwTjS5y.js";import{S as u}from"./SessionCard-1h54UV4S.js";import"./preload-helper-CwRszBsw.js";import"./CardMetadata-Cg3uMLCQ.js";const j=d("absolute top-1/2 z-10 -translate-y-1/2","flex items-center justify-center","h-10 w-10 rounded-full","bg-zinc-800 border border-zinc-700","text-zinc-400 hover:text-white hover:bg-zinc-700","transition-all duration-200","disabled:opacity-0 disabled:pointer-events-none","focus:outline-none focus:ring-2 focus:ring-zinc-500"),ue=d("flex overflow-x-auto scroll-smooth","scrollbar-none [-ms-overflow-style:none] [scrollbar-width:none]","[&::-webkit-scrollbar]:hidden","snap-x snap-mandatory"),me=d("h-2 rounded-full transition-all duration-200","focus:outline-none focus:ring-2 focus:ring-zinc-500 focus:ring-offset-2 focus:ring-offset-zinc-900");function _({direction:r,className:R}){return e.jsx("svg",{className:R,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round",children:r==="left"?e.jsx("polyline",{points:"15 18 9 12 15 6"}):e.jsx("polyline",{points:"9 18 15 12 9 6"})})}function h({children:r,className:R,gap:E=16,showArrows:Y=!0,showDots:Z=!1,scrollCount:k=1,"aria-label":ee="Carousel"}){const p=i.useRef(null),[ae,re]=i.useState(!1),[te,se]=i.useState(!0),[oe,ne]=i.useState(0),[M,ie]=i.useState(0),T=ce.Children.toArray(r),C=i.useCallback(()=>{const t=p.current;if(!t)return;const{scrollLeft:a,scrollWidth:n,clientWidth:A}=t,g=n-A;re(a>1),se(a<g-1);const c=t.children;if(c.length>0){ie(c.length);const y=g>0?a/g:0,U=Math.round(y*(c.length-1));ne(Math.min(Math.max(U,0),c.length-1))}},[]),le=i.useCallback(t=>{const a=p.current;if(!a)return;const n=a.children;if(n.length<=1)return;const{scrollWidth:A,clientWidth:g}=a,c=A-g,U=t/(n.length-1)*c;a.scrollTo({left:U,behavior:"smooth"})},[]),I=i.useCallback(t=>{const a=p.current;if(!a)return;const n=a.children;if(n.length===0)return;const c=(n[0].offsetWidth+E)*k,y=t==="left"?a.scrollLeft-c:a.scrollLeft+c;a.scrollTo({left:y,behavior:"smooth"})},[E,k]);return i.useEffect(()=>{const t=p.current;if(!t)return;C();const a=()=>C();t.addEventListener("scroll",a,{passive:!0});const n=new ResizeObserver(()=>C());return n.observe(t),()=>{t.removeEventListener("scroll",a),n.disconnect()}},[C]),i.useEffect(()=>{C()},[r,C]),e.jsxs("div",{className:d("relative w-full",R),role:"region","aria-label":ee,"aria-roledescription":"carousel",children:[e.jsx("div",{ref:p,className:ue,style:{gap:`${E}px`},tabIndex:0,"aria-live":"polite",children:T.map((t,a)=>e.jsx("div",{className:d("flex-shrink-0 snap-start","w-[280px] sm:w-[300px] lg:w-[320px]"),role:"group","aria-roledescription":"slide","aria-label":`${a+1} of ${T.length}`,children:t},a))}),Y&&e.jsxs(e.Fragment,{children:[e.jsx("button",{type:"button",onClick:()=>I("left"),disabled:!ae,className:d(j,"left-0 -translate-x-4"),"aria-label":"Previous items",children:e.jsx(_,{direction:"left",className:"h-5 w-5"})}),e.jsx("button",{type:"button",onClick:()=>I("right"),disabled:!te,className:d(j,"right-0 translate-x-4"),"aria-label":"Next items",children:e.jsx(_,{direction:"right",className:"h-5 w-5"})})]}),Z&&M>1&&e.jsx("div",{className:"flex justify-center gap-2 mt-4",role:"tablist","aria-label":"Carousel navigation",children:Array.from({length:M}).map((t,a)=>{const n=a===oe;return e.jsx("button",{type:"button",onClick:()=>le(a),className:d(me,n?"bg-white w-4":"bg-zinc-600 hover:bg-zinc-500 w-2"),role:"tab","aria-selected":n,"aria-label":`Go to slide ${a+1}`},a)})})]})}h.__docgenInfo={description:`Carousel Component
...
\`\`\`
`}}},argTypes:{gap:{control:{type:"number",min:0,max:48},description:"Gap between items in pixels"},showArrows:{control:"boolean",description:"Whether to show navigation arrows (desktop only)"},showDots:{control:"boolean",description:"Whether to show dot indicators"},scrollCount:{control:{type:"number",min:1,max:5},description:"Number of items to scroll at once (desktop)"}}},o=["https://picsum.photos/seed/char1/400/600","https://picsum.photos/seed/char2/400/600","https://picsum.photos/seed/char3/400/600","https://picsum.photos/seed/char4/400/600","https://picsum.photos/seed/char5/400/600"],m=["https://picsum.photos/seed/session1/800/400","https://picsum.photos/seed/session2/800/400","https://picsum.photos/seed/session3/800/400","https://picsum.photos/seed/session4/800/400"],l=["https://picsum.photos/seed/avatar1/100/100","https://picsum.photos/seed/avatar2/100/100","https://picsum.photos/seed/avatar3/100/100"],w={args:{showArrows:!0,showDots:!0,gap:16,scrollCount:1},render:r=>e.jsxs(h,{...r,"aria-label":"Character cards carousel",children:[e.jsx(s,{name:"Alice Wonderland",imageUrl:o[0],summary:"A curious young girl who falls down a rabbit hole into a fantasy world.",tags:["Fantasy","Adventure"],tokenCount:1523,updatedAt:"2 days ago"}),e.jsx(s,{name:"Mad Hatter",imageUrl:o[1],summary:"An eccentric character known for his tea parties and riddles.",tags:["Fantasy","Comedy"],tokenCount:2100,updatedAt:"1 week ago"}),e.jsx(s,{name:"Cheshire Cat",imageUrl:o[2],summary:"A mysterious cat with a distinctive grin who can appear and disappear at will.",tags:["Mystery","Fantasy"],tokenCount:1800,updatedAt:"3 days ago"}),e.jsx(s,{name:"Queen of Hearts",imageUrl:o[3],summary:"The tyrannical ruler of Wonderland known for her temper.",tags:["Villain","Royal"],tokenCount:900,updatedAt:"5 days ago"}),e.jsx(s,{name:"White Rabbit",imageUrl:o[4],summary:"A nervous rabbit always worried about being late.",tags:["Fantasy","Guide"],tokenCount:750,updatedAt:"Just now"})]})},S={args:{showArrows:!0,showDots:!0,gap:16},render:r=>e.jsxs(h,{...r,"aria-label":"Session cards carousel",children:[e.jsx(u,{title:"Adventure in Wonderland",imageUrl:m[0],messageCount:42,characterAvatars:[{name:"Alice",avatarUrl:l[0]},{name:"Hatter",avatarUrl:l[1]}]}),e.jsx(u,{title:"Tea Party Chaos",imageUrl:m[1],messageCount:128,characterAvatars:[{name:"Hatter",avatarUrl:l[1]},{name:"March Hare",avatarUrl:l[2]}]}),e.jsx(u,{title:"Court of the Queen",imageUrl:m[2],messageCount:256,characterAvatars:[{name:"Queen",avatarUrl:l[0]}]}),e.jsx(u,{title:"New Adventure",imageUrl:m[3],messageCount:0,characterAvatars:[]})]})},f={args:{showArrows:!0,showDots:!0,gap:20},render:r=>e.jsxs(h,{...r,"aria-label":"Mixed content carousel",children:[e.jsx(s,{name:"Alice Wonderland",imageUrl:o[0],summary:"A curious young girl who falls down a rabbit hole.",tags:["Fantasy"],tokenCount:1523}),e.jsx(u,{title:"Adventure in Wonderland",imageUrl:m[0],messageCount:42,characterAvatars:[{name:"Alice",avatarUrl:l[0]}]}),e.jsx(s,{name:"Mad Hatter",imageUrl:o[1],summary:"An eccentric character known for his tea parties.",tags:["Comedy"],tokenCount:2100}),e.jsx(u,{title:"Tea Party",imageUrl:m[1],messageCount:128,characterAvatars:[{name:"Hatter",avatarUrl:l[1]}]})]})},b={args:{showArrows:!1,showDots:!0,gap:12},parameters:{viewport:{defaultViewport:"mobile1"},docs:{description:{story:"Mobile-optimized carousel with dots only. Swipe to navigate."}}},render:r=>e.jsxs(h,{...r,"aria-label":"Mobile carousel",children:[e.jsx(s,{name:"Alice",imageUrl:o[0],summary:"A curious young girl.",tags:["Fantasy"],tokenCount:1523}),e.jsx(s,{name:"Hatter",imageUrl:o[1],summary:"Tea party host.",tags:["Comedy"],tokenCount:2100}),e.jsx(s,{name:"Cat",imageUrl:o[2],summary:"Mysterious feline.",tags:["Mystery"],tokenCount:1800})]})},v={args:{showArrows:!0,showDots:!1,gap:16,scrollCount:2},render:r=>e.jsxs(h,{...r,"aria-label":"Arrows only carousel",children:[e.jsx(s,{name:"Alice",imageUrl:o[0],summary:"A curious young girl.",tags:["Fantasy"],tokenCount:1523}),e.jsx(s,{name:"Hatter",imageUrl:o[1],summary:"Tea party host.",tags:["Comedy"],tokenCount:2100}),e.jsx(s,{name:"Cat",imageUrl:o[2],summary:"Mysterious feline.",tags:["Mystery"],tokenCount:1800}),e.jsx(s,{name:"Queen",imageUrl:o[3],summary:"Ruler of Wonderland.",tags:["Villain"],tokenCount:900})]})},x={args:{showArrows:!0,showDots:!1,gap:32},render:r=>e.jsxs(h,{...r,"aria-label":"Wide gap carousel",children:[e.jsx(u,{title:"Session One",imageUrl:m[0],messageCount:10,characterAvatars:[{name:"Alice",avatarUrl:l[0]}]}),e.jsx(u,{title:"Session Two",imageUrl:m[1],messageCount:25,characterAvatars:[{name:"Bob",avatarUrl:l[1]}]}),e.jsx(u,{title:"Session Three",imageUrl:m[2],messageCount:50,characterAvatars:[{name:"Cat",avatarUrl:l[2]}]})]})};var W,G,H;w.parameters={...w.parameters,docs:{...(W=w.parameters)==null?void 0:W.docs,source:{originalSource:`{
  args: {
    showArrows: true,
    showDots: true,
    gap: 16,
...
}`,...(H=(G=w.parameters)==null?void 0:G.docs)==null?void 0:H.source}}};var O,V,N;S.parameters={...S.parameters,docs:{...(O=S.parameters)==null?void 0:O.docs,source:{originalSource:`{
  args: {
    showArrows: true,
    showDots: true,
    gap: 16
...
}`,...(N=(V=S.parameters)==null?void 0:V.docs)==null?void 0:N.source}}};var D,F,z;f.parameters={...f.parameters,docs:{...(D=f.parameters)==null?void 0:D.docs,source:{originalSource:`{
  args: {
    showArrows: true,
    showDots: true,
    gap: 20
...
}`,...(z=(F=f.parameters)==null?void 0:F.docs)==null?void 0:z.source}}};var L,B,Q;b.parameters={...b.parameters,docs:{...(L=b.parameters)==null?void 0:L.docs,source:{originalSource:`{
  args: {
    showArrows: false,
    showDots: true,
    gap: 12
...
}`,...(Q=(B=b.parameters)==null?void 0:B.docs)==null?void 0:Q.source}}};var q,P,$;v.parameters={...v.parameters,docs:{...(q=v.parameters)==null?void 0:q.docs,source:{originalSource:`{
  args: {
    showArrows: true,
    showDots: false,
    gap: 16,
...
}`,...(X=(K=x.parameters)==null?void 0:K.docs)==null?void 0:X.source}}};const we=["WithCharacterCards","WithSessionCards","MixedContent","MobileStyle","ArrowsOnly","WideGap"];export{v as ArrowsOnly,f as MixedContent,b as MobileStyle,x as WideGap,w as WithCharacterCards,S as WithSessionCards,we as __namedExportsOrder,ye as default};
