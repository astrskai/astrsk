import{c as s}from"./createLucideIcon-MfmtVjtr.js";import{j as n}from"./iframe-DW8p3KlI.js";import{c as d}from"./utils-DuMXYCiK.js";/**
...
Mobile: Always visible`,methods:[],displayName:"CardActionToolbar",props:{actions:{required:!0,tsType:{name:"Array",elements:[{name:"CardAction"}],raw:"CardAction[]"},description:""},className:{required:!1,tsType:{name:"string"},description:""}}};function f({children:a}){return n.jsx("div",{className:"mt-auto flex items-center justify-between border-t border-zinc-800 pt-3 text-xs text-zinc-400",children:a})}function b({icon:a,children:r}){return n.jsxs("div",{className:"flex items-center gap-1",children:[a,r]})}f.__docgenInfo={description:`Container for metadata items in card components.
