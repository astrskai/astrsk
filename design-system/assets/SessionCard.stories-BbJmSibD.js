import{r as me,j as e}from"./iframe-Be38Beyt.js";import{c as Ys}from"./utils-CF6QUdYH.js";import{u as pt,B as Zs,C as ht,a as vt,b as Ee,c as xt,d as St,e as ft,S as Se,f as et,D as at,T as st,L as t,g as tt}from"./useImageRenderer-B6j3m1Yq.js";import{S as d}from"./Skeleton-CCpa4c49.js";import{L as l}from"./lock-B6XoOr2F.js";import{U as p}from"./user-BBNfae-v.js";import{S as ge,U as At}from"./users-jTxdeJjV.js";import"./preload-helper-CwRszBsw.js";import"./createLucideIcon-DwLq1bCy.js";function Ct({name:s,avatarUrl:o,loading:u="lazy"}){const[pe,x]=me.useState(!1);me.useEffect(()=>{x(!1)},[o]);const S=o&&!pe;return e.jsx("div",{className:"flex h-8 w-8 items-center justify-center overflow-hidden rounded-full border-2 border-zinc-900 bg-zinc-700",title:s,children:S?e.jsx("img",{src:o,alt:s,className:"h-full w-full object-cover",loading:u,onError:()=>x(!0)}):e.jsx("span",{className:"text-[10px] text-zinc-400",children:s.charAt(0).toUpperCase()||"?"})})}function xe(){return e.jsx("div",{className:"h-8 w-8 animate-pulse rounded-full border-2 border-zinc-900 bg-zinc-700"})}function kt({className:s}){return e.jsx("svg",{className:s,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round",children:e.jsx("path",{d:"M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"})})}const rt=St,ue=ft;function i({title:s,imageUrl:o,messageCount:u,actions:pe=[],className:x,isDisabled:S=!1,onClick:fe,characterAvatars:f=[],areCharactersLoading:Ae=!1,badges:A=[],renderMetadata:Ce,tags:C=[],summary:ke,likeButton:he,likeCount:be,downloadCount:ye,imageSizes:it,loading:ot="lazy",priority:lt=!1,renderImage:ct}){const[je,Le]=me.useState(!1),dt=pt({renderImage:ct});me.useEffect(()=>{Le(!1)},[o]);const mt=o&&!je,ut=o&&je,gt=()=>o?dt({src:o,alt:s,className:"absolute inset-0 h-full w-full object-cover opacity-80 transition-all duration-700 group-hover:scale-105 group-hover:opacity-90",sizes:it,loading:ot,onError:()=>Le(!0),fill:!0,priority:lt}):null;return e.jsxs(Zs,{className:Ys("min-h-[320px] w-full border-zinc-800 ring-1 ring-zinc-800/50",!S&&fe&&"hover:ring-zinc-700",x),isDisabled:S,onClick:fe,children:[e.jsxs("div",{className:"relative h-48 overflow-hidden bg-zinc-800",children:[mt?e.jsxs(e.Fragment,{children:[gt(),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-zinc-900 via-zinc-900/40 to-transparent"})]}):ut?e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"absolute inset-0 flex items-center justify-center",children:e.jsx("span",{className:"text-6xl font-bold text-zinc-500",children:s.charAt(0).toUpperCase()||"?"})}),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-zinc-900 to-transparent"})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"absolute inset-0 bg-zinc-800",children:e.jsx("div",{className:"absolute inset-0 opacity-20",style:{backgroundImage:"radial-gradient(#4f46e5 1px, transparent 1px)",backgroundSize:"16px 16px"}})}),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-zinc-900 to-transparent"})]}),he&&e.jsx("div",{className:"absolute top-2 right-2 z-20",children:e.jsx(ht,{...he})}),e.jsx(vt,{actions:pe,className:he?"top-12":void 0}),A.some(r=>(r.position??"left")==="left")&&e.jsx("div",{className:"absolute top-3 left-3 z-10 max-w-[45%]",children:e.jsx(Ee,{badges:A,position:"left"})}),A.some(r=>r.position==="right")&&e.jsx("div",{className:"absolute top-3 right-3 z-10 max-w-[45%]",children:e.jsx(Ee,{badges:A,position:"right"})}),e.jsx("div",{className:"absolute bottom-0 left-0 w-full p-5",children:e.jsx("h2",{className:"line-clamp-2 text-xl md:text-2xl leading-tight font-bold text-ellipsis text-white",children:s})})]}),e.jsx("div",{className:"flex flex-grow flex-col justify-between p-5",children:e.jsxs("div",{className:"space-y-2 md:space-y-3",children:[C.length>0&&e.jsxs("div",{className:"flex flex-wrap gap-2",children:[C.slice(0,3).map((r,ve)=>e.jsx("span",{className:"rounded border border-zinc-700/50 bg-zinc-800/80 px-1.5 py-0.5 text-[10px] text-zinc-300",children:r},`${r}-${ve}`)),C.length>3&&e.jsxs("span",{className:"rounded border border-zinc-700/50 bg-zinc-800/80 px-1.5 py-0.5 text-[10px] text-zinc-300",children:["+",C.length-3]})]}),ke&&e.jsx("p",{className:"line-clamp-2 text-xs leading-relaxed break-all text-ellipsis text-zinc-400",children:ke}),(be!==void 0||ye!==void 0)&&e.jsx(xt,{likeCount:be,downloadCount:ye}),Ce?Ce():u!==void 0&&e.jsx("div",{className:"flex items-center justify-between text-sm",children:u===0?e.jsx("span",{className:"text-zinc-400",children:"New session"}):e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(kt,{className:"h-4 w-4 text-zinc-400"}),e.jsx("span",{className:"font-semibold text-zinc-300",children:u.toLocaleString()}),e.jsx("span",{className:"text-zinc-400",children:u===1?"Message":"Messages"})]})}),(Ae||f.length>0)&&e.jsx("div",{className:"border-t border-zinc-800 pt-3",children:Ae?e.jsxs("div",{className:"flex -space-x-2",children:[e.jsx(xe,{}),e.jsx(xe,{}),e.jsx(xe,{})]}):e.jsxs("div",{className:"flex -space-x-2",children:[f.slice(0,3).map((r,ve)=>e.jsx(Ct,{name:r.name,avatarUrl:r.avatarUrl,loading:r.loading??"lazy"},`${r.name}-${ve}`)),f.length>3&&e.jsxs("div",{className:"flex h-8 w-8 items-center justify-center rounded-full border-2 border-zinc-900 bg-zinc-800 text-[10px] text-zinc-400",children:["+",f.length-3]})]})})]})})]})}i.__docgenInfo={description:"",methods:[],displayName:"SessionCard",props:{title:{required:!0,tsType:{name:"string"},description:"Session title"},imageUrl:{required:!1,tsType:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}]},description:"Cover image URL"},messageCount:{required:!1,tsType:{name:"number"},description:"Number of messages in the session (used in default metadata)"},actions:{required:!1,tsType:{name:"Array",elements:[{name:"CardAction"}],raw:"CardAction[]"},description:"Action buttons displayed on the card",defaultValue:{value:"[]",computed:!1}},className:{required:!1,tsType:{name:"string"},description:"Additional CSS classes"},isDisabled:{required:!1,tsType:{name:"boolean"},description:"Whether the card is disabled",defaultValue:{value:"false",computed:!1}},onClick:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"Click handler for the card"},characterAvatars:{required:!1,tsType:{name:"Array",elements:[{name:"CharacterAvatar"}],raw:"CharacterAvatar[]"},description:"Character avatars to display",defaultValue:{value:"[]",computed:!1}},areCharactersLoading:{required:!1,tsType:{name:"boolean"},description:"Whether characters are loading",defaultValue:{value:"false",computed:!1}},badges:{required:!1,tsType:{name:"Array",elements:[{name:"CardBadge"}],raw:"CardBadge[]"},description:"Badges to display on the card (e.g., type indicator, private, owner).",defaultValue:{value:"[]",computed:!1}},renderMetadata:{required:!1,tsType:{name:"signature",type:"function",raw:"() => React.ReactNode",signature:{arguments:[],return:{name:"ReactReactNode",raw:"React.ReactNode"}}},description:`Custom render function for the metadata section.
...
}`,...(Me=(ze=a.parameters)==null?void 0:ze.docs)==null?void 0:Me.source}}};var Ne,Ue,Te;k.parameters={...k.parameters,docs:{...(Ne=k.parameters)==null?void 0:Ne.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    badges: [{
      label: 'SESSION',
...
}`,...(Te=(Ue=k.parameters)==null?void 0:Ue.docs)==null?void 0:Te.source}}};var De,Pe,_e;b.parameters={...b.parameters,docs:{...(De=b.parameters)==null?void 0:De.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    badges: [{
      label: 'SESSION',
...
}`,...(_e=(Pe=b.parameters)==null?void 0:Pe.docs)==null?void 0:_e.source}}};var Be,Re,Ie;y.parameters={...y.parameters,docs:{...(Be=y.parameters)==null?void 0:Be.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    badges: [{
      label: 'SESSION',
...
}`,...(Xe=(Ke=w.parameters)==null?void 0:Ke.docs)==null?void 0:Xe.source}}};var Ye,Ze,ea;z.parameters={...z.parameters,docs:{...(Ye=z.parameters)==null?void 0:Ye.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    badges: [{
      label: 'SESSION',
...
}`,...(ea=(Ze=z.parameters)==null?void 0:Ze.docs)==null?void 0:ea.source}}};var aa,sa,ta;M.parameters={...M.parameters,docs:{...(aa=M.parameters)==null?void 0:aa.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    badges: [{
...
}`,...(ta=(sa=M.parameters)==null?void 0:sa.docs)==null?void 0:ta.source}}};var ra,na,ia;N.parameters={...N.parameters,docs:{...(ra=N.parameters)==null?void 0:ra.docs,source:{originalSource:`{
  args: {
    title: 'New Adventure',
...
}`,...(ca=(la=U.parameters)==null?void 0:la.docs)==null?void 0:ca.source}}};var da,ma,ua;T.parameters={...T.parameters,docs:{...(da=T.parameters)==null?void 0:da.docs,source:{originalSource:`{
  args: {
...
}`,...(ua=(ma=T.parameters)==null?void 0:ma.docs)==null?void 0:ua.source}}};var ga,pa,ha;D.parameters={...D.parameters,docs:{...(ga=D.parameters)==null?void 0:ga.docs,source:{originalSource:`{
  args: {
...
}`,...(ha=(pa=D.parameters)==null?void 0:pa.docs)==null?void 0:ha.source}}};var va,xa,Sa;P.parameters={...P.parameters,docs:{...(va=P.parameters)==null?void 0:va.docs,source:{originalSource:`{
  args: {
...
}`,...(Sa=(xa=P.parameters)==null?void 0:xa.docs)==null?void 0:Sa.source}}};var fa,Aa,Ca;_.parameters={..._.parameters,docs:{...(fa=_.parameters)==null?void 0:fa.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    title: 'Group Session',
    characterAvatars: [{
...
}`,...(Ca=(Aa=_.parameters)==null?void 0:Aa.docs)==null?void 0:Ca.source}}};var ka,ba,ya;B.parameters={...B.parameters,docs:{...(ka=B.parameters)==null?void 0:ka.docs,source:{originalSource:`{
  args: {
    ...Default.args,
...
}`,...(Ea=(La=R.parameters)==null?void 0:La.docs)==null?void 0:Ea.source}}};var wa,za,Ma;I.parameters={...I.parameters,docs:{...(wa=I.parameters)==null?void 0:wa.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    title: 'The Exceptionally Long Session Title That Should Be Truncated After Two Lines'
  }
}`,...(Ma=(za=I.parameters)==null?void 0:za.docs)==null?void 0:Ma.source}}};var Na,Ua,Ta;V.parameters={...V.parameters,docs:{...(Na=V.parameters)==null?void 0:Na.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    actions: [{
      icon: Edit,
...
}`,...(Ta=(Ua=V.parameters)==null?void 0:Ua.docs)==null?void 0:Ta.source}}};var Da,Pa,_a;W.parameters={...W.parameters,docs:{...(Da=W.parameters)==null?void 0:Da.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    title: 'Epic Campaign',
    messageCount: 12345
  }
}`,...(_a=(Pa=W.parameters)==null?void 0:Pa.docs)==null?void 0:_a.source}}};var Ba,Ra,Ia;O.parameters={...O.parameters,docs:{...(Ba=O.parameters)==null?void 0:Ba.docs,source:{originalSource:`{
  args: {
    ...Default.args,
...
}`,...(Ss=(xs=Z.parameters)==null?void 0:xs.docs)==null?void 0:Ss.source}}};var fs,As,Cs;ee.parameters={...ee.parameters,docs:{...(fs=ee.parameters)==null?void 0:fs.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    likeButton: {
      isLiked: false,
...
}`,...(Cs=(As=ee.parameters)==null?void 0:As.docs)==null?void 0:Cs.source}}};var ks,bs,ys;ae.parameters={...ae.parameters,docs:{...(ks=ae.parameters)==null?void 0:ks.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    likeButton: {
      isLiked: true,
...
}`,...(Es=(Ls=se.parameters)==null?void 0:Ls.docs)==null?void 0:Es.source}}};var ws,zs,Ms;te.parameters={...te.parameters,docs:{...(ws=te.parameters)==null?void 0:ws.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    downloadCount: 5678
  }
}`,...(Ms=(zs=te.parameters)==null?void 0:zs.docs)==null?void 0:Ms.source}}};var Ns,Us,Ts;re.parameters={...re.parameters,docs:{...(Ns=re.parameters)==null?void 0:Ns.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    likeCount: 1234,
    downloadCount: 5678
  }
}`,...(Ts=(Us=re.parameters)==null?void 0:Us.docs)==null?void 0:Ts.source}}};var Ds,Ps,_s;ne.parameters={...ne.parameters,docs:{...(Ds=ne.parameters)==null?void 0:Ds.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    likeButton: {
      isLiked: false,
...
}`,...(_s=(Ps=ne.parameters)==null?void 0:Ps.docs)==null?void 0:_s.source}}};var Bs,Rs,Is;ie.parameters={...ie.parameters,docs:{...(Bs=ie.parameters)==null?void 0:Bs.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    likeButton: {
      isLiked: true,
