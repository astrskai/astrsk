...
function CharacterEditPanel({
  ...
  // Use hook to manage object URL lifecycle - automatically cleans up on unmount/file change
  // Falls back to character.data?.imageUrl for externally provided URLs (e.g., from AI chat)
  ...
  useEffect(() => {
    ...
    const updatedCharacter: DraftCharacter = {
      ...
      data: {
        ...
        tags,
        imageFile,
        // Don't store object URL - it will be regenerated by useFilePreviewUrl when needed
        imageUrl: undefined,
