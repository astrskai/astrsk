    ...
    <div className="py-8">
      ...
      <div className="prose prose-invert max-w-none text-fg-default">
        <p className="mb-6 text-fg-muted">
          Hello and welcome! These Terms of Use are an agreement formed between
          you and harpy chat Inc. In these Terms we'll sometimes refer to harpy
          chat Inc. as "Company," "we," or "us." We'll refer to astrsk.ai,
          together with any content, tools, features and functionality offered
          on or through them, as the "Services."
        </p>
        ...
        <p className="mb-6 text-fg-muted">
          ...
          rights. By accessing or using the Services, you're agreeing to these
          Terms. If you don't understand or agree to these Terms, please don't
          use the Services.
        </p>
        ...
        <p className="mb-6 font-semibold text-fg-default">
          NOTE: THESE TERMS CONTAIN AN ARBITRATION CLAUSE AND CLASS ACTION
          WAIVER. By agreeing to these Terms, you agree to resolve all disputes
          with us through binding individual arbitration. That means you also
          ...
          arbitrations, or representative actions. You have the right to opt out
          of arbitration as explained below.
        </p>
        ...
        <p className="mb-6 text-fg-muted">
          Your Registration Obligations. When you register to use the Services,
          ...
          under 16 years old, do not sign up for the Services – you are not
          authorized to use them.
        </p>
        <p className="mb-6 text-fg-muted">
          You acknowledge and agree that any questions, comments, suggestions,
          ideas, feedback or other information about the Services provided by
          you to astrsk.ai are non-confidential, and that we are entitled to use
          and disseminate them for any purpose, without acknowledgment of or
          compensation to you.
        </p>

        <p className="mb-6 text-fg-muted">
          You acknowledge and agree that we may preserve metadata in compliance
          with our Privacy Policy. You acknowledge and agree that we may
          disclose data if required to do so by law or in the good faith belief
          ...
          enforce these Terms; (c) protect the rights, property, or personal
          safety of astrsk.ai, its users and the public.
        </p>
        ...
        <p className="mb-6 text-fg-muted">
          ...
          harmless from any and all losses, damages, and expenses of any kind
          arising out of or relating to your use of the Services. Without
          limiting the foregoing, the release and indemnification described
          above includes reasonable attorneys' fees, rights, claims, actions of
          any kind and injury (including death) arising out of or relating to
        ...
        <p className="mb-6 text-fg-muted">
          Your use of the Services is at your sole risk. The site is provided on
          an "AS IS" and "AS AVAILABLE" basis. harpy chat Inc. expressly
          ...
          non-infringement. harpy chat Inc. makes no warranty that (i) the
          Services will meet your requirements, (ii) the results that may be
        ...
        <p className="mb-6 text-fg-muted">
          You understand and agree that harpy chat Inc. will not be liable for
          ...
          Services; (ii) your access, use, creation of, or interaction with any
          Content, Character or Generations; (iii) your sharing with any third
          party of any Content, Character or Generations; or (vi) any other
        ...
        <p className="mb-6 text-fg-muted">
          ...
          section of the Terms is referred to in these Terms as the "Arbitration
          Agreement." You agree that any and all disputes or claims that have
          arisen or may arise between you and harpy chat Inc., whether arising
          out of or relating to these Terms (including any alleged breach
          thereof), the Website or Services, any aspect of the relationship or
          ...
          your behalf. You agree that, by entering into these Terms, you and
          harpy chat Inc. are each waiving the right to a trial by jury or to
        ...
        <p className="mb-6 text-fg-muted">
          ...
          Non-Individualized Relief. You and harpy chat Inc. agree that each of
          us may bring claims against the other only on an individual basis and
          not as a plaintiff or class member in any purported class or
          representative action or proceeding. Unless both you and harpy chat
          Inc. agree otherwise, the arbitrator may not consolidate or join more
        ...
        <h3 className="mb-4 mt-8 font-semibold text-fg-default">General</h3>

        <p className="mb-2 text-fg-muted">
          <span className="font-medium text-fg-default">Entire Agreement.</span>{" "}
          These Terms constitute the entire agreement between you and harpy chat
          Inc. and govern your use of our Services, superseding any prior
          agreements between you and harpy chat Inc. with respect to the
          Services.
        </p>

        <p className="mb-2 text-fg-muted">
          <span className="font-medium text-fg-default">No Waiver.</span> Any
          failure of harpy chat Inc. to exercise or enforce any right or
        ...
        <p className="mb-2 text-fg-muted">
          ...
          Website or these Terms must be filed within one year after such claim
          or cause of action arose or be forever barred.
        </p>

        <p className="mb-6 text-fg-muted">
          <span className="font-medium text-fg-default">Notice.</span> Notices
          to you may be made via either email or regular mail. The Site may also
          provide notices to you of changes to these Terms or other matters by
        ...
        <p className="mb-6 text-fg-muted">
          ...
          effective no earlier than 14 days after they are posted, except that
          changes addressing new functions of the Services or changes made for
          legal reasons will be effective immediately. Your continued use of the
          Services after the date any such changes become effective constitutes
          your acceptance of the new Terms.
        </p>

        <h3 className="mb-4 mt-8 font-semibold text-fg-default">Contact Us</h3>
