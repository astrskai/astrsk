...
/**
 * Parses incomplete JSON by attempting to repair it.
 * Useful for streaming scenarios where JSON is received incrementally.
 *
 ...
 * @example
 * ```ts
 * // Handles incomplete JSON like: {"name": "John", "age":
 * const partial = parsePartialJson('{"name": "John", "age": ');
 * // Returns: { name: "John" }
 * ```
 */
