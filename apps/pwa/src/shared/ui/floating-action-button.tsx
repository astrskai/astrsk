  ...
  if (onboarding && onboardingTooltip) {
    return (
      <div className="group/fab-parent">
        ...
        <div
          className={cn(
            "bg-surface-raised border-accent-primary absolute top-[16px] z-20 rounded-2xl border-1 px-4 py-3 whitespace-nowrap shadow-[0px_0px_15px_-3px_rgba(152,215,249,1.00)]",
            ...
            tooltipSide === "right" &&
              position === "top-left" &&
              "left-[160px]",
            tooltipSide === "right" && position === "top-left",
            tooltipSide === "right" &&
              position === "top-right" &&
              "left-[90px]",
            tooltipSide === "left" &&
              position === "top-left" &&
              "right-[160px]",
            tooltipSide === "left" && position === "top-left",
            tooltipSide === "left" &&
              position === "top-right" &&
              "right-[90px]",
        ...
        >
          <div className="text-fg-default text-xs font-medium">
            {onboardingTooltip}
          </div>
        </div>
        ...
        <Button
          className={cn(
            ...
            onboarding &&
              "border-accent-primary border-1 shadow-[0px_0px_15px_-3px_rgba(152,215,249,1.00)] hover:shadow-[0px_0px_20px_-1px_rgba(152,215,249,1.00)]",
            className,
          )}
          onClick={(event) => {
            onClick?.(event);
