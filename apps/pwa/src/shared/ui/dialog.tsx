...
>(({ className, children, hideClose = false, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "bg-dark-surface outline-dark-surface fixed top-[50%] left-[50%] z-100 grid w-[95vw] max-w-md translate-x-[-50%] translate-y-[-50%] gap-6 rounded-lg p-6 shadow-[0px_10px_10px_-5px_rgba(0,0,0,0.10),0px_10px_25px_-5px_rgba(0,0,0,0.30)] outline-1 outline-offset-[-1px] md:w-[85vw] md:max-w-3xl lg:max-w-5xl xl:max-w-7xl",
