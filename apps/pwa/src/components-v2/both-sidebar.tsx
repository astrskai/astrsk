...
>(({ side, setOpen, isMobile, className, children, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "bg-[#2A313A] group-data-[variant=floating]:border-sidebar-border flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-xs",
        className,
      )}
  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "relative h-[calc(100svh-var(--topbar-height))] w-(--sidebar-width) bg-transparent transition-[width] duration-200 ease-linear",
        ...
        <div
          className={cn(
            "absolute inset-y-0 z-30 h-[calc(100svh-var(--topbar-height))] w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear flex",
            side === "left"
...
function SidebarOpenTrigger({
  ...
  return (
    <FloatingActionButton
      ...
      icon={icon ?? <List className="min-w-[24px] min-h-[24px]" />}
      label={label}
      {...props}
    />
  );
  ...
  return (
    <FloatingActionButton
      ...
      icon={
        icon ??
        (side === "left" ? (
          <ArrowLeftFromLine className="min-w-[24px] min-h-[24px]" />
        ) : (
          <ArrowRightFromLine className="min-w-[24px] min-h-[24px]" />
        ))
      }
      label={label}
      {...props}
  ...
  return (
    <main
      className={cn(
        ...
        "peer-data-[variant=inset]:min-h-[calc(100svh-(--spacing(4)))] peer-data-[variant=inset]:m-2 peer-data-[state=collapsed]:peer-data-[variant=inset]:ml-2 peer-data-[variant=inset]:ml-0 peer-data-[variant=inset]:rounded-xl peer-data-[variant=inset]:shadow-xs",
        className,
      )}
      ref={ref}
      {...props}
